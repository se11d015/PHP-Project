...
<table class="table table-bordered table-striped">
  <thead>
    <tr>
      <th><?php echo _p("ExportText1")." "._p("ResourceSubTitle6")." "._p("ExportText2"); ?></th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>
        <form class="form" role="form" action="<?php echo $my_url.$search_url.$sort_url; ?>" enctype="multipart/form-data" method="post" name="mainform" id="mainform">
		  <div class="form-group row col-md-6">
			...
			<div class="col-md-3">
			  <input type="text" class="form-control" name="export_utilization_year" id="export_utilization_year"/>
			</div>
		  </div>		  
		  <div class="form-group row col-md-6">
