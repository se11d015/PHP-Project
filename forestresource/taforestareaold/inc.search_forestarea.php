        ...
        <td><form class="form" role="form" action="<?php echo $my_url; ?>" method="post" name="mainform" id="mainform">
              ...
              <div class="form-group row col-md-6">
                ...
                <div class="col-md-7">
                  <?php
					...
					echo seldatadb("stype_code", "form-control", $rows, "type_code", "type_name_$language_name", $stype_code, "", _p("AllTypes"));
					?>
                </div>
              </div>		  
            </div>
            ...
            <div class="form-row">
              <div class="form-group row col-md-10 justify-content-end">
                <button type="submit" class="btn btn-primary" name="searchforestareabttn"><i class="fa fa-search"></i> <?php echo _p("SearchButton"); ?></button>
              </div>
            </div>
          </form></td>
      </tr>
