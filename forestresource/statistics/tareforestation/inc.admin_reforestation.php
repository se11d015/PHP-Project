...
//$HORIZONTAL_ELEMENT_NAME = array("1"=>"reforest_year", "2"=>"aimag_code", "3"=>"soum_code");
...
$VERTICAL_ELEMENT_ID = array("1"=>_p("StatisticsSub5Column1"),"2"=>_p("StatisticsSub5Column2"),"3"=>_p("StatisticsSub5Column3"),"4"=>_p("StatisticsSub5Column4"),
"5"=>_p("StatisticsSub5Column6"),"6"=>_p("StatisticsSub5Column7"),"7"=>_p("StatisticsSub5Column8"),
"8"=>_p("StatisticsSub5Column9"),"9"=>_p("StatisticsSub5Column10"),"10"=>_p("StatisticsSub5Column11"),
"11"=>_p("StatisticsSub5Column12"),"12"=>_p("StatisticsSub5Column13"),"13"=>_p("StatisticsSub5Column14"),"14"=>_p("StatisticsSub5Column15"),
);
$VERTICAL_ELEMENT_NAME = array("1"=>"planted_area","2"=>"regenerate_area","3"=>"forest_belt_area","4"=>"planted_forest_area",
"5"=>"seedling_1age_number","6"=>"seedling_2age_number","7"=>"seedling_3age_number",
"8"=>"seedling_number_larch","9"=>"seedling_number_pine","10"=>"seedling_number_other",
"11"=>"prepared_seed_larch","12"=>"prepared_seed_pine","13"=>"prepared_seed_saxaul","14"=>"prepared_seed_other",
);
$VERTICAL_ELEMENT_UNIT = array("1"=>_p("StatisticsSub5Unit1"),"2"=>_p("StatisticsSub5Unit1"),"3"=>_p("StatisticsSub5Unit1"),"4"=>_p("StatisticsSub5Unit1"),
"5"=>_p("StatisticsSub5Unit3"),"6"=>_p("StatisticsSub5Unit3"),"7"=>_p("StatisticsSub5Unit3"),
"8"=>_p("StatisticsSub5Unit3"),"9"=>_p("StatisticsSub5Unit3"),"10"=>_p("StatisticsSub5Unit3"),
"11"=>_p("StatisticsSub5Unit4"),"12"=>_p("StatisticsSub5Unit4"),"13"=>_p("StatisticsSub5Unit4"),"14"=>_p("StatisticsSub5Unit4"),
);


$selQuery = "SELECT MIN(taf.reforest_year) minyear, MAX(taf.reforest_year) maxyear FROM ".$schemas.".tareforestation taf";
...
require("statistics/tareforestation/inc.search_reforestation.php");	
...
{
	$searchQuery .= " AND taf.reforest_year = ".$statistic_year;
}
...
$fromQuery = "FROM ".$schemas.".tareforestation taf, scadministrative.vasoumname va";
$whereQuery = "WHERE taf.soum_code = va.soum_code";
$groupQuery = "GROUP BY";
$sortQuery = "ORDER BY";

if($statistic_horizontal_id==1){
	$valueQuery .= ", taf.reforest_year";
	$groupQuery .= " taf.reforest_year";
	$sortQuery .= " taf.reforest_year DESC";
...
<div class="tab-content" id="nav-tabContent">
  <div class="tab-pane fade show active" id="nav-sub1" role="tabpanel" aria-labelledby="nav-sub1-tab">
	...
	<div class="table-responsive">
	  <table id="forestresource_datatables" class="table table-bordered table-hover" title_name="<?php echo _p("ResourceSubTitle5"); ?>" file_name="statisticsdata" column_name="0, 1, 2" language_name="<?php echo $language_name;?>" page_count="<?php echo $count;?>">
		<thead>
		  <tr>
