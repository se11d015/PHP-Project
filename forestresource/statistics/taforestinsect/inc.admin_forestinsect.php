...
//$HORIZONTAL_ELEMENT_NAME = array("1"=>"insect_year", "2"=>"aimag_code", "3"=>"soum_code");
...
$VERTICAL_ELEMENT_ID = array("1"=>_p("StatisticsSub4Column1"),"2"=>_p("StatisticsSub4Column2"),"3"=>_p("StatisticsSub4Column3"),
"4"=>_p("StatisticsSub4Column4"),"5"=>_p("StatisticsSub4Column5"),"6"=>_p("StatisticsSub4Column6"),"7"=>_p("StatisticsSub4Column7"),"8"=>_p("StatisticsSub4Column8"),
);
$VERTICAL_ELEMENT_NAME = array("1"=>"insect_study_area","2"=>"insect_spread_area","3"=>"insect_damage_area",
"4"=>"control_aeroplain_number","5"=>"control_aeroplain_area","6"=>"control_spray_area","7"=>"control_mechanics_area","8"=>"control_mechanics_size",
);
$VERTICAL_ELEMENT_UNIT = array("1"=>_p("StatisticsSub4Unit1"),"2"=>_p("StatisticsSub4Unit1"),"3"=>_p("StatisticsSub4Unit1"),
"4"=>_p("StatisticsSub4Unit2"),"5"=>_p("StatisticsSub4Unit1"),"6"=>_p("StatisticsSub4Unit1"),"7"=>_p("StatisticsSub4Unit3"),"8"=>_p("StatisticsSub4Unit1"),
);

$selQuery = "SELECT MIN(taf.insect_year) minyear, MAX(taf.insect_year) maxyear FROM ".$schemas.".taforestinsect taf";
...
require("statistics/taforestinsect/inc.search_forestinsect.php");	
...
{
	$searchQuery .= " AND taf.insect_year = ".$statistic_year;
}
...
$fromQuery = "FROM ".$schemas.".taforestinsect taf, scadministrative.vasoumname va";
$whereQuery = "WHERE taf.soum_code = va.soum_code";
$groupQuery = "GROUP BY";
$sortQuery = "ORDER BY";

if($statistic_horizontal_id==1){
	$valueQuery .= ", taf.insect_year";
	$groupQuery .= " taf.insect_year";
	$sortQuery .= " taf.insect_year DESC";
...
<div class="tab-content" id="nav-tabContent">
  <div class="tab-pane fade show active" id="nav-sub1" role="tabpanel" aria-labelledby="nav-sub1-tab">
	...
	<div class="table-responsive">
	  <table id="forestresource_datatables" class="table table-bordered table-hover" title_name="<?php echo _p("ResourceSubTitle4"); ?>" file_name="statisticsdata" column_name="0, 1, 2" language_name="<?php echo $language_name;?>" page_count="<?php echo $count;?>">
		<thead>
		  <tr>
