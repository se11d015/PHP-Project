<?php	
//$HORIZONTAL_ELEMENT_ID8 = array("1"=>_p("StatisticsRow1"), "2"=>_p("StatisticsRow2"), "3"=>_p("StatisticsRow3"));
//$HORIZONTAL_ELEMENT_NAME8 = array("1"=>"violation_year", "2"=>"aimag_code", "3"=>"soum_code");;
...
$VERTICAL_ELEMENT_ID = array("1"=>_p("StatisticsSub8Column1"),"2"=>_p("StatisticsSub8Column2"),"3"=>_p("StatisticsSub8Column3"),"4"=>_p("StatisticsSub8Column4"),"5"=>_p("StatisticsSub8Column5"),
);
$VERTICAL_ELEMENT_NAME = array("1"=>"violation_number","2"=>"illegallogging_wood","3"=>"forfeit_cost","4"=>"indemnity_cost","5"=>"illegal_nontimberproduct",
);
$VERTICAL_ELEMENT_UNIT = array("1"=>_p("StatisticsSub8Unit1"),"2"=>_p("StatisticsSub8Unit2"),"3"=>_p("StatisticsSub8Unit3"),"4"=>_p("StatisticsSub8Unit3"),"5"=>_p("StatisticsSub8Unit4"),
);

$selQuery = "SELECT MIN(taf.violation_year) minyear, MAX(taf.violation_year) maxyear FROM ".$schemas.".taviolation taf";
...
require("statistics/taviolation/inc.search_violation.php");	
...
{
	$searchQuery .= " AND taf.violation_year = ".$statistic_year;
}
...
$fromQuery = "FROM ".$schemas.".taviolation taf, scadministrative.vasoumname va";
$whereQuery = "WHERE taf.soum_code = va.soum_code";
$groupQuery = "GROUP BY";
$sortQuery = "ORDER BY";

if($statistic_horizontal_id==1){
	$valueQuery .= ", taf.violation_year";
	$groupQuery .= " taf.violation_year";
	$sortQuery .= " taf.violation_year DESC";
...
<div class="tab-content" id="nav-tabContent">
  <div class="tab-pane fade show active" id="nav-sub1" role="tabpanel" aria-labelledby="nav-sub1-tab">
	...
	<div class="table-responsive">
	  <table id="forestresource_datatables" class="table table-bordered table-hover" title_name="<?php echo _p("ResourceSubTitle8"); ?>" file_name="statisticsdata" column_name="0, 1, 2" language_name="<?php echo $language_name;?>" page_count="<?php echo $count;?>">
		<thead>
		  <tr>
