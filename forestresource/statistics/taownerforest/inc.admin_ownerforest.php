...
//$HORIZONTAL_ELEMENT_NAME = array("1"=>"owner_year", "2"=>"aimag_code", "3"=>"soum_code");
...
$VERTICAL_ELEMENT_ID = array("1"=>_p("StatisticsSub7Column1"),"2"=>_p("StatisticsSub7Column2"),"3"=>_p("StatisticsSub7Column3"),"4"=>_p("StatisticsSub7Column4"),
"5"=>_p("StatisticsSub7Column5"),"6"=>_p("StatisticsSub7Column6"),"7"=>_p("StatisticsSub7Column7"),"8"=>_p("StatisticsSub7Column8"),
);
$VERTICAL_ELEMENT_NAME = array("1"=>"owner_community_number","2"=>"owner_organization_number","3"=>"owner_other_number","4"=>"total_owner_number",
"5"=>"owner_community_area","6"=>"owner_organization_area","7"=>"owner_other_area","8"=>"total_owner_area",
);
$VERTICAL_ELEMENT_UNIT = array("1"=>_p("StatisticsSub7Unit1"),"2"=>_p("StatisticsSub7Unit1"),"3"=>_p("StatisticsSub7Unit1"),"4"=>_p("StatisticsSub7Unit1"),
"5"=>_p("StatisticsSub7Unit2"),"6"=>_p("StatisticsSub7Unit2"),"7"=>_p("StatisticsSub7Unit2"),"8"=>_p("StatisticsSub7Unit2"),
);

$selQuery = "SELECT MIN(taf.owner_year) minyear, MAX(taf.owner_year) maxyear FROM ".$schemas.".taownerforest taf";
...
require("statistics/taownerforest/inc.search_ownerforest.php");	
...
{
	$searchQuery .= " AND taf.owner_year = ".$statistic_year;
}
...
$fromQuery = "FROM ".$schemas.".taownerforest taf, scadministrative.vasoumname va";
$whereQuery = "WHERE taf.soum_code = va.soum_code";
$groupQuery = "GROUP BY";
$sortQuery = "ORDER BY";

if($statistic_horizontal_id==1){
	$valueQuery .= ", taf.owner_year";
	$groupQuery .= " taf.owner_year";
	$sortQuery .= " taf.owner_year DESC";
...
<div class="tab-content" id="nav-tabContent">
  <div class="tab-pane fade show active" id="nav-sub1" role="tabpanel" aria-labelledby="nav-sub1-tab">
	...
	<div class="table-responsive">
	  <table id="forestresource_datatables" class="table table-bordered table-hover" title_name="<?php echo _p("ResourceSubTitle7"); ?>" file_name="statisticsdata" column_name="0, 1, 2" language_name="<?php echo $language_name;?>" page_count="<?php echo $count;?>">
		<thead>
		  <tr>
