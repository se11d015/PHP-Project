<?php
//$HORIZONTAL_ELEMENT_ID = array("1"=>_p("StatisticsRow1"), "2"=>_p("StatisticsRow2"), "3"=>_p("StatisticsRow3"), "4"=>_p("StatisticsRow5"));
//$HORIZONTAL_ELEMENT_NAME = array("1"=>"volume_year", "2"=>"aimag_code", "3"=>"soum_code", "4"=>"tree_code");

$HORIZONTAL_ELEMENT_ID = array("2"=>_p("StatisticsRow2"), "3"=>_p("StatisticsRow3"), "4"=>_p("StatisticsRow5"));
$HORIZONTAL_ELEMENT_NAME = array("2"=>"aimag_code", "3"=>"soum_code", "4"=>"tree_code");
$VERTICAL_ELEMENT_ID = array("1"=>_p("StatisticsSub2Column1"), "2"=>_p("StatisticsSub2Column2"), "3"=>_p("StatisticsSub2Column3"), "4"=>_p("StatisticsSub2Column4"));
$VERTICAL_ELEMENT_NAME = array("1"=>"growing_volume", "2"=>"driedstanding_volume", "3"=>"fallen_volume", "4"=>"volume_change");
$VERTICAL_ELEMENT_UNIT = array("1"=>_p("StatisticsSub2Unit1"), "2"=>_p("StatisticsSub2Unit1"), "3"=>_p("StatisticsSub2Unit1"), "4"=>_p("StatisticsSub2Unit1"));

$selQuery = "SELECT MIN(taf.volume_year) minyear, MAX(taf.volume_year) maxyear FROM ".$schemas.".taforestvolume taf";
...
require("statistics/taforestvolume/inc.search_forestvolume.php");	
...
{
	$searchQuery .= " AND taf.volume_year = ".$statistic_year;
}
...
$fromQuery = "FROM ".$schemas.".taforestvolume taf, scadministrative.vasoumname va";
$whereQuery = "WHERE taf.soum_code = va.soum_code";
$groupQuery = "GROUP BY";
$sortQuery = "ORDER BY";

if($statistic_horizontal_id==1){
	$valueQuery .= ", taf.volume_year";
	$groupQuery .= " taf.volume_year";
	$sortQuery .= " taf.volume_year DESC";
	...
	$valueQuery .= ", tct.tree_name_mn, tct.tree_name_en";
	$fromQuery .= ", ".$schemas.".tctreetype tct";
	$whereQuery .= " AND taf.tree_code = tct.tree_code";
	$groupQuery .= " tct.tree_name_mn, tct.tree_name_en";
	$sortQuery .= " tct.tree_name_mn, tct.tree_name_en";
}
...
<div class="tab-content" id="nav-tabContent">
  <div class="tab-pane fade show active" id="nav-sub1" role="tabpanel" aria-labelledby="nav-sub1-tab">
	...
	<div class="table-responsive">
	  <table id="forestresource_datatables" class="table table-bordered table-hover" title_name="<?php echo _p("ResourceSubTitle2"); ?>" file_name="statisticsdata" column_name="0, 1, 2" language_name="<?php echo $language_name;?>" page_count="<?php echo $count;?>">
		<thead>
		  <tr>
