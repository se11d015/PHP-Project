<?php
//$HORIZONTAL_ELEMENT_ID6 = array("1"=>_p("StatisticsRow1"), "2"=>_p("StatisticsRow2"), "3"=>_p("StatisticsRow3"));
//$HORIZONTAL_ELEMENT_NAME6 = array("1"=>"utilization_year", "2"=>"aimag_code", "3"=>"soum_code");
...
$VERTICAL_ELEMENT_ID = array("1"=>_p("StatisticsSub6Column1"),"2"=>_p("StatisticsSub6Column2"),"3"=>_p("StatisticsSub6Column3"),"4"=>_p("StatisticsSub6Column4"),"5"=>_p("StatisticsSub6Column5"),"6"=>_p("StatisticsSub6Column6"),
"7"=>_p("StatisticsSub6Column7"),"8"=>_p("StatisticsSub6Column8"),"9"=>_p("StatisticsSub6Column9"),"10"=>_p("StatisticsSub6Column10"),
"11"=>_p("StatisticsSub6Column11"),"12"=>_p("StatisticsSub6Column12"),"13"=>_p("StatisticsSub6Column13"),
"14"=>_p("StatisticsSub6Column14"),"15"=>_p("StatisticsSub6Column15"),"16"=>_p("StatisticsSub6Column16"),
);
$VERTICAL_ELEMENT_NAME = array("1"=>"logged_timber","2"=>"logged_firewood","3"=>"total_logged_wood","4"=>"insulated_area","5"=>"logged_area",
"6"=>"thinning_area","7"=>"thinning_timber","8"=>"thinning_firewood","9"=>"total_thinning_wood",
"10"=>"cleaning_area","11"=>"cleaning_timber","12"=>"cleaning_firewood","13"=>"total_cleaning_wood",
"14"=>"nontimber_pinenuts","15"=>"nontimber_fruits","16"=>"nontimber_other",
);
$VERTICAL_ELEMENT_UNIT = array("1"=>_p("StatisticsSub6Unit1"),"2"=>_p("StatisticsSub6Unit1"),"3"=>_p("StatisticsSub6Unit1"),"4"=>_p("StatisticsSub6Unit2"),"5"=>_p("StatisticsSub6Unit2"),
"6"=>_p("StatisticsSub6Unit2"),"7"=>_p("StatisticsSub6Unit1"),"8"=>_p("StatisticsSub6Unit1"),"9"=>_p("StatisticsSub6Unit1"),
"10"=>_p("StatisticsSub6Unit2"),"11"=>_p("StatisticsSub6Unit1"),"12"=>_p("StatisticsSub6Unit1"),"13"=>_p("StatisticsSub6Unit1")
,"14"=>_p("StatisticsSub6Unit3"),"15"=>_p("StatisticsSub6Unit3"),"16"=>_p("StatisticsSub6Unit3"),
);

$selQuery = "SELECT MIN(taf.utilization_year) minyear, MAX(taf.utilization_year) maxyear FROM ".$schemas.".taforestutilization taf";
...
require("statistics/taforestutilization/inc.search_forestutilization.php");	
...
{
	$searchQuery .= " AND taf.utilization_year = ".$statistic_year;
}
...
$fromQuery = "FROM ".$schemas.".taforestutilization taf, scadministrative.vasoumname va";
$whereQuery = "WHERE taf.soum_code = va.soum_code";
$groupQuery = "GROUP BY";
$sortQuery = "ORDER BY";

if($statistic_horizontal_id==1){
	$valueQuery .= ", taf.utilization_year";
	$groupQuery .= " taf.utilization_year";
	$sortQuery .= " taf.utilization_year DESC";
...
<div class="tab-content" id="nav-tabContent">
  <div class="tab-pane fade show active" id="nav-sub1" role="tabpanel" aria-labelledby="nav-sub1-tab">
	...
	<div class="table-responsive">
	  <table id="forestresource_datatables" class="table table-bordered table-hover" title_name="<?php echo _p("ResourceSubTitle6"); ?>" file_name="statisticsdata" column_name="0, 1, 2" language_name="<?php echo $language_name;?>" page_count="<?php echo $count;?>">
		<thead>
		  <tr>
