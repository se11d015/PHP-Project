<?php
if (isset($_POST["searchforestinsectgeombttn"])) 
{
	$searchQuery = "";
	$search_url = "";
...
if (isset($_GET["sort"])) 
{
	...
	{
        $sortQuery .= " tgf.insect_damage_area";
    } else if ($_GET["sort"] == 5) 
	{
        $sortQuery .= " tgf.control_type";
    } else if ($_GET["sort"] == 6) 
	{
        $sortQuery .= " tgf.control_area";		
    } else
	{
...
$startQuery = "SELECT";
$valueQuery = "COUNT(*) AS num_count FROM ".$schemas.".tgforestinsect tgf, ".$schemas.".taforestinsect taf, scadministrative.vasoumname vs";
...
require("tgforestinsect/inc.search_forestinsect.php");	
...
<div class="table-responsive">
  <table id="forestresource_datatables" class="table table-bordered table-hover" title_name="<?php echo _p("GisSubTitle1"); ?>" file_name="forestinsect" column_name="0, 1, 2, 3, 4, 5, 6, 7" language_name="<?php echo $language_name;?>" page_count="<?php echo $count;?>">
    <thead>
      <tr>
      ...
      <tr>
        <th>№</th>
        <th><a href="<?php echo $my_url."&sort=1&sorttype=".$sorttype.$search_url; ?>" style="color:#FFFFFF"><i class="fa fa-sort"></i> <?php echo _p("GisSub1Column3"); ?></a></th>		
        <th><a href="<?php echo $my_url."&sort=2&sorttype=".$sorttype.$search_url; ?>" style="color:#FFFFFF"><i class="fa fa-sort"></i> <?php echo _p("GisSub1Column1"); ?></a></th>
        <th><a href="<?php echo $my_url."&sort=3&sorttype=".$sorttype.$search_url; ?>" style="color:#FFFFFF"><i class="fa fa-sort"></i> <?php echo _p("GisSub1Column2"); ?></a></th>
        <th><a href="<?php echo $my_url."&sort=4&sorttype=".$sorttype.$search_url; ?>" style="color:#FFFFFF"><i class="fa fa-sort"></i> <?php echo _p("GisSub1Column4").", ". _p("GisSub1Unit2"); ?></a></th>
        <th><a href="<?php echo $my_url."&sort=5&sorttype=".$sorttype.$search_url; ?>" style="color:#FFFFFF"><i class="fa fa-sort"></i> <?php echo _p("GisSub1Column6"); ?></a></th>
        <th><a href="<?php echo $my_url."&sort=6&sorttype=".$sorttype.$search_url; ?>" style="color:#FFFFFF"><i class="fa fa-sort"></i> <?php echo _p("GisSub1Column7").", ". _p("GisSub1Unit2"); ?></a></th>
    ...
    <tbody>
      <?php
		...
		taf.insect_year, vs.aimag_name_mn, vs.aimag_name_en, vs.soum_name_mn, vs.soum_name_en FROM ".$schemas.".tgforestinsect tgf, ".$schemas.".taforestinsect taf, scadministrative.vasoumname vs";
		$whereQuery = "WHERE tgf.insect_id = taf.insect_id AND taf.soum_code = vs.soum_code";
      ...
      <tr>
        ...
        <td><?php if($rows[$i]["control_type"]==1) echo _p("GisSub1MoreColumn1"); 
			else if($rows[$i]["control_type"]==2) echo _p("GisSub1MoreColumn2");
			else if($rows[$i]["control_type"]==3) echo _p("GisSub1MoreColumn3"); ?></td>
        <td><?php echo $rows[$i]["control_area"]; ?></td>
        <td><?php 
