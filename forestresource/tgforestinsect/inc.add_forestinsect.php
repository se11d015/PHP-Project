...
if ($sess_profile==1 || $db->isGroupRole($schemas, $sess_profile, $sess_user_id, 11, 2)) 
{
	...
	$startQuery = "SELECT";
	$valueQuery = "taf.insect_id, taf.insect_year, vs.aimag_name_mn, vs.aimag_name_en, vs.soum_name_mn, vs.soum_name_en FROM ".$schemas.".taforestinsect taf, scadministrative.vasoumname vs";
...
{
    document.getElementById("insertforestinsectgeombttn").value = "1";
...
<div class="table-responsive">
  <table class="table table-bordered table-striped">
    <thead>
      <tr>
        <th><?php echo _p("AddText5")." "._p("GisSubTitle1")." "._p("AddText6"); ?></th>
      </tr>
    </thead>
    <tbody>
      <tr>
          ...
          <form class="form" action="<?php echo $my_url.$search_url.$sort_url; ?>" enctype="multipart/form-data" method="post" name="mainform" id="mainform">
            ...
            <div class="form-group row">
			 ...
			 <div class="form-group row">
			    ...
			    <table>
				 <tbody>
					...
					<tr>
					  ...
					  <td>
					    <div class="form-check form-check-inline">
						  <input class="form-check-input" type="radio" name="control_type" id="control_type" value="1" checked>
						  <label class="form-check-label" for="inlineCheckbox1"><?php echo _p("GisSub1MoreColumn1");?></label>
						</div>
						<div class="form-check form-check-inline">
						  <input class="form-check-input" type="radio" name="control_type" id="control_type" value="2">
						  <label class="form-check-label" for="inlineCheckbox2"><?php echo _p("GisSub1MoreColumn2");?></label>
						</div>
						<div class="form-check form-check-inline">
						  <input class="form-check-input" type="radio" name="control_type" id="control_type" value="3">
					...
					<tr>
					  ...
					  <td><?php echo _p("GisSub1Unit2");?></td>
					  <td><input type="text" class="form-control" name="control_area" id="control_area"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextReal11"); ?></span></td>
					</tr>
					<tr>
					  <th>5.</th>
			  ...
			  <input type="hidden" id="insertforestinsectgeombttn" name="insertforestinsectgeombttn" value="0"/>
