...
if (isset($_POST["searchforestinsectbttn"])) 
{
	...
	$slinsect_year = (isset($_POST["slinsect_year"])) ? (int) $_POST["slinsect_year"] : 0;		
	...
	{
		$searchQuery .= " AND taf.insect_year = ".$slinsect_year;
		$search_url_new .= "&slinsect_year=".$slinsect_year;
	}
}
...
require("tgforestinsect/inc.select_search_forestinsect.php");	
...
<div class="table-responsive">
  <table id="forestresource_datatables" class="table table-bordered table-hover" title_name="<?php echo _p("ResourceSubTitle4"); ?>" file_name="forestinsect" column_name="0, 1, 2, 3, 4, 5, 6" language_name="<?php echo $language_name;?>" page_count="<?php echo $count;?>">
    <thead>	
      ...
      <tr>
        <th>№</th>
        <th><a href="<?php echo $my_url."&sort=1&sorttype=".$sorttype.$search_url_new; ?>" style="color:#FFFFFF"><i class="fa fa-sort"></i> <?php echo _p("ResourceSub4Column3"); ?></a></th>		
        <th><a href="<?php echo $my_url."&sort=2&sorttype=".$sorttype.$search_url_new; ?>" style="color:#FFFFFF"><i class="fa fa-sort"></i> <?php echo _p("ResourceSub4Column1"); ?></a></th>
        <th><a href="<?php echo $my_url."&sort=3&sorttype=".$sorttype.$search_url_new; ?>" style="color:#FFFFFF"><i class="fa fa-sort"></i> <?php echo _p("ResourceSub4Column2"); ?></a></th>
        <th><a href="<?php echo $my_url."&sort=4&sorttype=".$sorttype.$search_url_new; ?>" style="color:#FFFFFF"><i class="fa fa-sort"></i> <?php echo _p("ResourceSub4Column4"); ?></a></th>
        <th><a href="<?php echo $my_url."&sort=5&sorttype=".$sorttype.$search_url_new; ?>" style="color:#FFFFFF"><i class="fa fa-sort"></i> <?php echo _p("ResourceSub4Column5"); ?></a></th>
        <th><a href="<?php echo $my_url."&sort=6&sorttype=".$sorttype.$search_url_new; ?>" style="color:#FFFFFF"><i class="fa fa-sort"></i> <?php echo _p("ResourceSub4Column6"); ?></a></th>		
      ...
      <tr>
        ...
        <td>
          <?php 
			...
			{ 
			?>
          <a class="btn btn-primary" href="<?php echo $my_url.$my_page.$search_url_new.$sort_url_new."&action=add&insect_id=".$rows[$i]["insect_id"]; ?>"><i class="fa fa-plus"></i> <?php echo _p("AddButton");?></a>
          <?php
