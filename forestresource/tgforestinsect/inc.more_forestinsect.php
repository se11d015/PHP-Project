...
taf.insect_year, vs.aimag_name_mn, vs.aimag_name_en, vs.soum_name_mn, vs.soum_name_en, tau.organization||' - '|| tau.lastname as user_name 
FROM ".$schemas.".tgforestinsect tgf, ".$schemas.".taforestinsect taf, scadministrative.vasoumname vs,".$schemas.".tausers tau";
$whereQuery = "WHERE tgf.insect_id = taf.insect_id AND taf.soum_code = vs.soum_code AND tgf.user_id = tau.user_id AND tgf.gid = ".$gid;
...
<div class="table-responsive">
  <table class="table table-bordered table-striped table-hover">
    <thead>
      <tr>
        <th colspan="5"><?php echo _p("MoreText1")." "._p("GisSubTitle1")." "._p("MoreText2"); ?></th>
      </tr>
      <tr>
        <th style="width: 5%">№</th>
    ...
    <tbody>
        <tr>
          <th>1.</th>
          <td><?php echo _p("GisSub1Column3");?></td>
          <td><?php echo _p("GisSub1Unit1");?></td>
          <td><?php echo $row[$i]["insect_year"]; ?></td>
        </tr>
        <tr>
          <th>2.</th>
          <td><?php echo _p("GisSub1Column1");?></td>
          <td><?php echo _p("GisSub1Unit1");?></td>
          <td><?php echo $row[$i]["aimag_name_$language_name"]; ?></td>
        </tr>
        <tr>
          <th>3.</th>
          <td><?php echo _p("GisSub1Column2");?></td>
          <td><?php echo _p("GisSub1Unit1");?></td>
        ...
        <tr>
          ...
          <td><?php echo _p("GisSub1Unit1");?></td>
          <td><?php 
		    if($row[$i]["control_type"]==1) echo _p("GisSub1MoreColumn1"); 
			else if($row[$i]["control_type"]==2) echo _p("GisSub1MoreColumn2");
			else if($row[$i]["control_type"]==3) echo _p("GisSub1MoreColumn3");
		  ?></td>
        </tr>		
        <tr>
          <th>7.</th>
          ...
          <td><?php echo _p("GisSub1Unit2");?></td>
          <td><?php echo $row[$i]["control_area"]; ?></td>
        </tr>
        <tr>
          <th>8.</th>
