...
<div class="table-responsive">
  <table class="table table-bordered table-striped">
    <thead>
      <tr>
        <th><?php echo _p("SelectText1")." "._p("ResourceSubTitle7")." "._p("SelectText2"); ?></th>
      </tr>	
      <tr>
        ...
        <td><form class="form" role="form" action="<?php echo $my_url; ?>" method="post" name="mainform" id="mainform">
            <div class="form-row">
              <div class="form-group row col-md-6">
                ...
                <div class="col-md-3">
                  <input type="text" class="form-control" name="slowner_year" id="slowner_year" value="<?php if($slowner_year>0) echo $slowner_year;?>"/>
                </div>
              </div>
              <div class="form-group row col-md-6">
            ...
            <div class="form-row">
              <div class="form-group row col-md-10 justify-content-end">
                <button type="submit" class="btn btn-primary" name="searchownerforestbttn"><i class="fa fa-search"></i> <?php echo _p("SearchButton"); ?></button>
              </div>
            </div>
          </form></td>
      </tr>
