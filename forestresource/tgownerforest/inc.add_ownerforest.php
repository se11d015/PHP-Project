...
if ($sess_profile==1 || $db->isGroupRole($schemas, $sess_profile, $sess_user_id, 15, 2)) 
{
	...
	$startQuery = "SELECT";
	$valueQuery = "taf.owner_id, taf.owner_year, vs.aimag_name_mn, vs.aimag_name_en, vs.soum_name_mn, vs.soum_name_en FROM ".$schemas.".taownerforest taf, scadministrative.vasoumname vs";
...
{
    document.getElementById("insertownerforestgeombttn").value = "1";
...
<div class="table-responsive">
  <table class="table table-bordered table-striped">
    <thead>
      <tr>
        <th><?php echo _p("AddText5")." "._p("GisSubTitle5")." "._p("AddText6"); ?></th>
      </tr>
    </thead>
    <tbody>
      <tr>
          ...
          <form class="form" action="<?php echo $my_url.$search_url.$sort_url; ?>" enctype="multipart/form-data" method="post" name="mainform" id="mainform">
            ...
            <div class="form-group row">
			 ...
			 <div class="form-group row">
			  ...
			  <div class="form-group row col-md-12">
			    <table>
				 <tbody>
					...
					<tr>
					  ...
					  <td>
					    <div class="form-check form-check-inline">
						  <input class="form-check-input" type="radio" name="owner_type" id="owner_type" value="1" checked>
						  <label class="form-check-label" for="inlineCheckbox1"><?php echo _p("GisSub5MoreColumn1");?></label>
						</div>
						<div class="form-check form-check-inline">
						  <input class="form-check-input" type="radio" name="owner_type" id="owner_type" value="2">
						  <label class="form-check-label" for="inlineCheckbox2"><?php echo _p("GisSub5MoreColumn2");?></label>
						</div>
						<div class="form-check form-check-inline">
						  <input class="form-check-input" type="radio" name="owner_type" id="owner_type" value="3">
					...
					<tr>
					  <th>2.</th>
					  <td><?php echo _p("GisSub5Column5");?></td>
					  <td><?php echo _p("GisSub5Unit2");?></td>
					  <td><input type="text" class="form-control" name="owner_area" id="owner_area"/></td>
					  ...
					  <tr>
						...
						<td><?php echo _p("GisSub5Unit1");?></td>
						<td><textarea class="form-control" name="owner_act" id="owner_act" rows="3"></textarea></td>
						<td><span class="form-text text-muted"><?php echo _p("AlertTextCharAll"); ?></span></td>
					  </tr>
					  <tr>
						<th>5.</th>
						...
						<td><?php echo _p("GisSub5Unit1");?></td>
						<td><input type="file" class="form-control-file" name="owner_plan" id="owner_plan" /></td>
						<td><span class="form-text text-muted"><?php echo _p("BrowseFileText1"); ?></span></td>
					  </tr>
					<tr>
					  <th>6.</th>
			  ...
			  <input type="hidden" id="insertownerforestgeombttn" name="insertownerforestgeombttn" value="0"/>
