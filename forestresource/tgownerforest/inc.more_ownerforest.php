...
taf.owner_year, vs.aimag_name_mn, vs.aimag_name_en, vs.soum_name_mn, vs.soum_name_en, tau.organization||' - '|| tau.lastname as user_name 
FROM ".$schemas.".tgownerforest tgf, ".$schemas.".taownerforest taf, scadministrative.vasoumname vs,".$schemas.".tausers tau";
$whereQuery = "WHERE tgf.owner_id = taf.owner_id AND taf.soum_code = vs.soum_code AND tgf.user_id = tau.user_id AND tgf.gid = ".$gid;
...
<div class="table-responsive">
  <table class="table table-bordered table-striped table-hover">
    <thead>
      <tr>
        <th colspan="5"><?php echo _p("MoreText1")." "._p("GisSubTitle5")." "._p("MoreText2"); ?></th>
      </tr>
      <tr>
        <th style="width: 5%">№</th>
    ...
    <tbody>
        <tr>
          <th>1.</th>
          <td><?php echo _p("GisSub5Column3");?></td>
          <td><?php echo _p("GisSub5Unit1");?></td>
          <td><?php echo $row[$i]["owner_year"]; ?></td>
        </tr>
        <tr>
          <th>2.</th>
          <td><?php echo _p("GisSub5Column1");?></td>
          <td><?php echo _p("GisSub5Unit1");?></td>
          <td><?php echo $row[$i]["aimag_name_$language_name"]; ?></td>
        </tr>
        <tr>
          <th>3.</th>
          <td><?php echo _p("GisSub5Column2");?></td>
          <td><?php echo _p("GisSub5Unit1");?></td>
        ...
        <tr>
          ...
          <td><?php echo _p("GisSub5Unit1");?></td>
          <td><?php 
		    if($row[$i]["owner_type"]==1) echo _p("GisSub5MoreColumn1"); 
			else if($row[$i]["owner_type"]==2) echo _p("GisSub5MoreColumn2");
			else if($row[$i]["owner_type"]==3) echo _p("GisSub5MoreColumn3");
		  ?></td>
        </tr>		
        <tr>
          <th>5.</th>
          ...
          <td><?php echo $row[$i]["owner_area"]; ?></td>
        </tr>
        <tr>
          <th>6.</th>
        ...
        <tr>
          ...
          <td><?php echo _p("GisSub5Unit1");?></td>
          <td><?php echo $row[$i]["owner_act"]; ?></td>
        </tr>
        <tr>
          <th>8.</th>
          <td><?php echo _p("GisSub5Column8");?></td>
          <td><?php echo _p("GisSub5Unit1");?></td>
          <td><?php if(!empty($row[$i]["owner_plan"])) { ?>
          <a href="<?php echo $row[$i]["owner_plan"]; ?>" target="_blank"><?php echo _p("BrowseFileButton");?></a>
          <?php } ?></td>
        </tr>		
        <tr>
          <th>9.</th>
