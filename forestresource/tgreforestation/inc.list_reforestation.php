<?php
if (isset($_POST["searchreforestationgeombttn"])) 
{
	$searchQuery = "";
	$search_url = "";
...
if (isset($_GET["sort"])) 
{
	...
	{
        $sortQuery .= " tgf.reforest_type";
    } else if ($_GET["sort"] == 5) 
	{
        $sortQuery .= " tgf.reforest_area";
    } else
	{
...
$startQuery = "SELECT";
$valueQuery = "COUNT(*) AS num_count FROM ".$schemas.".tgreforestation tgf, ".$schemas.".tareforestation taf, scadministrative.vasoumname vs";
...
require("tgreforestation/inc.search_reforestation.php");	
...
<div class="table-responsive">
  <table id="forestresource_datatables" class="table table-bordered table-hover" title_name="<?php echo _p("GisSubTitle2"); ?>" file_name="reforestation" column_name="0, 1, 2, 3, 4, 5, 6" language_name="<?php echo $language_name;?>" page_count="<?php echo $count;?>">
    <thead>
      <tr>
      ...
      <tr>
        <th>№</th>
        <th><a href="<?php echo $my_url."&sort=1&sorttype=".$sorttype.$search_url; ?>" style="color:#FFFFFF"><i class="fa fa-sort"></i> <?php echo _p("GisSub2Column3"); ?></a></th>		
        <th><a href="<?php echo $my_url."&sort=2&sorttype=".$sorttype.$search_url; ?>" style="color:#FFFFFF"><i class="fa fa-sort"></i> <?php echo _p("GisSub2Column1"); ?></a></th>
        <th><a href="<?php echo $my_url."&sort=3&sorttype=".$sorttype.$search_url; ?>" style="color:#FFFFFF"><i class="fa fa-sort"></i> <?php echo _p("GisSub2Column2"); ?></a></th>
        <th><a href="<?php echo $my_url."&sort=4&sorttype=".$sorttype.$search_url; ?>" style="color:#FFFFFF"><i class="fa fa-sort"></i> <?php echo _p("GisSub2Column4"); ?></a></th>
        <th><a href="<?php echo $my_url."&sort=5&sorttype=".$sorttype.$search_url; ?>" style="color:#FFFFFF"><i class="fa fa-sort"></i> <?php echo _p("GisSub2Column5").", ". _p("GisSub2Unit2"); ?></a></th>
    ...
    <tbody>
      <?php
		...
		taf.reforest_year, vs.aimag_name_mn, vs.aimag_name_en, vs.soum_name_mn, vs.soum_name_en FROM ".$schemas.".tgreforestation tgf, ".$schemas.".tareforestation taf, scadministrative.vasoumname vs";
		$whereQuery = "WHERE tgf.reforest_id = taf.reforest_id AND taf.soum_code = vs.soum_code";
      ...
      <tr>
        ...
        <td><?php if($rows[$i]["reforest_type"]==1) echo _p("GisSub2MoreColumn1"); 
			else if($rows[$i]["reforest_type"]==2) echo _p("GisSub2MoreColumn2");
			else if($rows[$i]["reforest_type"]==3) echo _p("GisSub2MoreColumn3"); ?></td>
        <td><?php echo $rows[$i]["reforest_area"]; ?></td>
        <td><?php 
