...
if ($sess_profile==1 || $db->isGroupRole($schemas, $sess_profile, $sess_user_id, 12, 2)) 
{
	...
	$startQuery = "SELECT";
	$valueQuery = "taf.reforest_id, taf.reforest_year, vs.aimag_name_mn, vs.aimag_name_en, vs.soum_name_mn, vs.soum_name_en FROM ".$schemas.".tareforestation taf, scadministrative.vasoumname vs";
...
{
    document.getElementById("insertreforestationgeombttn").value = "1";
...
<div class="table-responsive">
  <table class="table table-bordered table-striped">
    <thead>
      <tr>
        <th><?php echo _p("AddText5")." "._p("GisSubTitle2")." "._p("AddText6"); ?></th>
      </tr>
    </thead>
    <tbody>
      <tr>
          ...
          <form class="form" action="<?php echo $my_url.$search_url.$sort_url; ?>" enctype="multipart/form-data" method="post" name="mainform" id="mainform">
            ...
            <div class="form-group row">
			 ...
			 <div class="form-group row">
			    ...
			    <table>
				 <tbody>
					...
					<tr>
					  ...
					  <td>
					    <div class="form-check form-check-inline">
						  <input class="form-check-input" type="radio" name="reforest_type" id="reforest_type" value="1" checked>
						  <label class="form-check-label" for="inlineCheckbox1"><?php echo _p("GisSub2MoreColumn1");?></label>
						</div>
						<div class="form-check form-check-inline">
						  <input class="form-check-input" type="radio" name="reforest_type" id="reforest_type" value="2">
						  <label class="form-check-label" for="inlineCheckbox2"><?php echo _p("GisSub2MoreColumn2");?></label>
						</div>
						<div class="form-check form-check-inline">
						  <input class="form-check-input" type="radio" name="reforest_type" id="reforest_type" value="3">
					...
					<tr>
					  ...
					  <td><input type="text" class="form-control" name="reforest_area" id="reforest_area"/></td>
			  ...
			  <input type="hidden" id="insertreforestationgeombttn" name="insertreforestationgeombttn" value="0"/>
