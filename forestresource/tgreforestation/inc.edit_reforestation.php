...
if ($sess_profile==1 || $db->isGroupRole($schemas, $sess_profile, $sess_user_id, 12, 2)) 
{
	...
	FROM ".$schemas.".tgreforestation tgf, ".$schemas.".tareforestation taf, scadministrative.vasoumname vs";
...
{
    document.getElementById("updatereforestationgeombttn").value = "1";
...
<div class="table-responsive">
  <table class="table table-bordered table-striped">
    <thead>
      <tr>
        <th><?php echo _p("EditText3")." "._p("GisSubTitle2")." "._p("EditText4"); ?></th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td><div class="alert alert-warning" role="alert"><?php echo _p("AlertText"); ?></div>
          <form class="form" action="<?php echo $my_url.$my_page.$search_url.$sort_url; ?>" enctype="multipart/form-data" method="post" name="mainform" id="mainform">
            ...
            <div class="form-group row">
              <label class="col-md-3 col-form-label"><?php echo _p("GisSub2Column3"); ?>:</label>
              <div class="col-md-4">
                <input type="text" readonly class="form-control-plaintext" value="<?php echo $row[$i]["reforest_year"]; ?>"/>
              </div>
            </div>				
            <div class="form-group row">
              <label class="col-md-3 col-form-label"><?php echo _p("GisSub2Column1"); ?>:</label>
              <div class="col-md-4">
                <input type="text" readonly class="form-control-plaintext" value="<?php echo $row[$i]["aimag_name_$language_name"]; ?>"/>
              </div>
            </div>
			 <div class="form-group row">
              <label class="col-md-3 col-form-label"><?php echo _p("GisSub2Column2"); ?>:</label>
              <div class="col-md-4">
			    ...
			    <table>
				 <tbody>
					...
					<tr>
					  ...
					  <td>
					    <div class="form-check form-check-inline">
						  <input class="form-check-input" type="radio" name="reforest_type" id="reforest_type" value="1" <?php if($row[$i]["reforest_type"]==1) echo "checked"; ?>>
						  <label class="form-check-label" for="inlineCheckbox1"><?php echo _p("GisSub2MoreColumn1");?></label>
						</div>
						<div class="form-check form-check-inline">
						  <input class="form-check-input" type="radio" name="reforest_type" id="reforest_type" value="2" <?php if($row[$i]["reforest_type"]==2) echo "checked"; ?>>
						  <label class="form-check-label" for="inlineCheckbox2"><?php echo _p("GisSub2MoreColumn2");?></label>
						</div>
						<div class="form-check form-check-inline">
						  <input class="form-check-input" type="radio" name="reforest_type" id="reforest_type" value="3" <?php if($row[$i]["reforest_type"]==3) echo "checked"; ?>>
						  <label class="form-check-label" for="inlineCheckbox3"><?php echo _p("GisSub2MoreColumn3");?></label>
						</div></td>
					...
					<tr>
					  ...
					  <td><input type="text" class="form-control" name="reforest_area" id="reforest_area" value="<?php echo $row[$i]["reforest_area"]; ?>"/></td>
            ...
            <input type="hidden" id="updatereforestationgeombttn" name="updatereforestationgeombttn" value="0"/>
