...
$startQuery = "SELECT";
$valueQuery = "va.aimag_name_mn, va.soum_name_mn, va.aimag_name_en, va.soum_name_en, taf.* FROM ".$schemas.".taforestfire taf, scadministrative.vasoumname va";
$whereQuery = "WHERE taf.soum_code = va.soum_code AND taf.fire_id=".$fire_id;
...
if (!empty($row))
{
	$title = $row[$i]["aimag_name_$language_name"]." "._p("ForestResourceText1")." ".$row[$i]["soum_name_$language_name"]." "._p("ForestResourceText2").", ".$row[$i]["fire_year"]." "._p("ForestResourceText3");
?>
<h4 class="sub-omheader "><?php echo _p("ResourceSubTitle3"); ?></h4>	  
  ...
  <table class="table table-bordered table-hover">
    <thead>
      ...
      <tr>
        ...
        <th colspan="2"><?php echo _p("ResourceSub3ColumnText1");?></th>
        <th><?php echo _p("ResourceSub3ColumnText2");?></th>
