...
function addsubmitform()
{
    if (document.getElementById("fire_year").value == "") {
        ...
        document.getElementById("insertforestfirebttn").value = "1";
...
<div class="table-responsive">
  <table class="table table-bordered table-striped">
    <thead>
      <tr>
        <th><?php echo _p("AddText5")." "._p("ResourceSubTitle3")." "._p("AddText6"); ?></th>
      </tr>
    </thead>
    <tbody>
      <tr>
          ...
          <form class="form" action="<?php echo $my_url.$search_url.$sort_url; ?>" enctype="multipart/form-data" method="post" name="mainform" id="mainform">
			  <div class="form-row">
				<div class="form-group col-md-3">
				  <label class="col-form-label text-danger"><?php echo _p("ResourceSub3Column1"); ?> *</label>
				  <?php
				...
				<div class="form-group col-md-3">
				  <label class="col-form-label text-danger"><?php echo _p("ResourceSub3Column2"); ?> *</label>
				  <?php
				...
				<div class="form-group col-md-2">
				  <label class="col-form-label text-danger"><?php echo _p("ResourceSub3Column3"); ?> *</label>
				  <input type="text" class="form-control" name="fire_year" id="fire_year">
				</div>				
			  </div>
			    ...
			    <table>
				 <tbody>
					...
					<tr>
					  ...
					  <td><input type="text" class="form-control" name="fire_number" id="fire_number"/></td>
					...
					<tr>
					  ...
					  <td><?php echo _p("ResourceSub3Unit2");?></td>
					  <td><textarea class="form-control" name="fire_date" id="fire_date" rows="2"></textarea></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextChar100"); ?></span></td>
					</tr>
					<tr>
					  <th rowspan="5">4.</th>
					  ...
					  <td><input type="text" class="form-control" name="burnt_forest_area" id="burnt_forest_area" onChange="summary_area()"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextReal11"); ?> </span></td>
					</tr>
					<tr>
					  <td><?php echo _p("ResourceSub3MoreColumn5");?></td>
					  <td><?php echo _p("ResourceSub3Unit3");?></td>
					  <td><input type="text" class="form-control" name="burnt_pasture_area" id="burnt_pasture_area" onChange="summary_area()"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextReal11"); ?> </span></td>					  
					</tr>
					<tr>
					  <td><?php echo _p("ResourceSub3MoreColumn6");?></td>
					  <td><?php echo _p("ResourceSub3Unit3");?></td>
					  <td><input type="text" class="form-control" name="burnt_argiculture_area" id="burnt_argiculture_area" onChange="summary_area()"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextReal11"); ?> </span></td>	
					</tr>
					<tr>
					  <td><?php echo _p("ResourceSub3MoreColumn7");?></td>
					  <td><?php echo _p("ResourceSub3Unit3");?></td>
					  <td><input type="text" class="form-control" name="burnt_grassland_area" id="burnt_grassland_area" onChange="summary_area()"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextReal11"); ?> </span></td>	
					</tr>
					<tr>
					  <td><?php echo _p("ResourceSub3MoreColumn8");?></td>
					  <td><?php echo _p("ResourceSub3Unit3");?></td>
					  <td><input type="text" disabled class="form-control" name="total_burnt_area" id="total_burnt_area"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextReal11"); ?> </span></td>	
					</tr>
					<tr>
					  <th rowspan="4">5.</th>
					  ...
					  <td><?php echo _p("ResourceSub3Unit3");?></td>
					  <td><input type="text" class="form-control" name="burnt_larch_area" id="burnt_larch_area"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextReal11"); ?> </span></td>					  
					</tr>
					<tr>
					  <td><?php echo _p("ResourceSub3MoreColumn10");?></td>
					  <td><?php echo _p("ResourceSub3Unit3");?></td>
					  <td><input type="text" class="form-control" name="burnt_pine_area" id="burnt_pine_area"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextReal11"); ?> </span></td>						  
					</tr>
					<tr>
					  <td><?php echo _p("ResourceSub3MoreColumn11");?></td>
					  <td><?php echo _p("ResourceSub3Unit3");?></td>
					  <td><input type="text" class="form-control" name="burnt_evergreen_area" id="burnt_evergreen_area"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextReal11"); ?> </span></td>	
					</tr>
					<tr>
					  <td><?php echo _p("ResourceSub3MoreColumn12");?></td>
					  <td><?php echo _p("ResourceSub3Unit3");?></td>
					  <td><input type="text" class="form-control" name="burnt_othertree_area" id="burnt_othertree_area"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextReal11"); ?> </span></td>						  
					</tr>
					<tr>
					  <th rowspan="5">6.</th>
					  ...
					  <td><?php echo _p("ResourceSub3Unit1");?></td>
					  <td><input type="text" class="form-control" name="mobilized_people_number" id="mobilized_people_number"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextInt1"); ?> </span></td>	
					</tr>
					<tr>
					  <td><?php echo _p("ResourceSub3MoreColumn14");?></td>
					  <td><?php echo _p("ResourceSub3Unit1");?></td>
					  <td><input type="text" class="form-control" name="mobilized_car_number" id="mobilized_car_number"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextInt1"); ?> </span></td>						  
					</tr>
					<tr>
					  <td><?php echo _p("ResourceSub3MoreColumn15");?></td>
					  <td><?php echo _p("ResourceSub3Unit1");?></td>
					  <td><input type="text" class="form-control" name="mobilized_tractor_number" id="mobilized_tractor_number"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextInt1"); ?> </span></td>						  
					</tr>
					<tr>
					  <td><?php echo _p("ResourceSub3MoreColumn16");?></td>
					  <td><?php echo _p("ResourceSub3Unit1");?></td>
					  <td><input type="text" class="form-control" name="mobilized_motorcycle_number" id="mobilized_motorcycle_number"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextInt1"); ?> </span></td>	
					</tr>
					<tr>
					  <td><?php echo _p("ResourceSub3MoreColumn17");?></td>
					  <td><?php echo _p("ResourceSub3Unit1");?></td>
					  <td><input type="text" class="form-control" name="mobilized_cart_number" id="mobilized_cart_number"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextInt1"); ?> </span></td>						  
					</tr>
					<tr>
					  <th rowspan="3">7.</th>
					  ...
					  <td><input type="text" class="form-control" name="forest_damage_cost" id="forest_damage_cost" onChange="summary_damage()"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextReal13"); ?></span></td>						  
					</tr>
					<tr>
					  <td><?php echo _p("ResourceSub3MoreColumn19");?></td>
					  <td><?php echo _p("ResourceSub3Unit4");?></td>
					  <td><input type="text" class="form-control" name="pasture_damage_cost" id="pasture_damage_cost" onChange="summary_damage()"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextReal13"); ?></span></td>						  
					</tr>
					<tr>
					  <td><?php echo _p("ResourceSub3MoreColumn20");?></td>
					  <td><?php echo _p("ResourceSub3Unit4");?></td>
					  <td><input type="text" class="form-control" name="wildlife_damage_cost" id="wildlife_damage_cost" onChange="summary_damage()"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextReal13"); ?></span></td>						  
					</tr>
					<tr>
					  <th rowspan="7">8.</th>
					  ...
					  <td><?php echo _p("ResourceSub3Unit4");?></td>
					  <td><input type="text" class="form-control" name="animal_damage_cost" id="animal_damage_cost" onChange="summary_damage()"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextReal13"); ?></span></td>						  
					</tr>
					<tr>
					  <td><?php echo _p("ResourceSub3MoreColumn22");?></td>
					  <td><?php echo _p("ResourceSub3Unit4");?></td>
					  <td><input type="text" class="form-control" name="ger_damage_cost" id="ger_damage_cost" onChange="summary_damage()"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextReal13"); ?></span></td>						  
					</tr>
					<tr>
					  <td><?php echo _p("ResourceSub3MoreColumn23");?></td>
					  <td><?php echo _p("ResourceSub3Unit4");?></td>
					  <td><input type="text" class="form-control" name="house_damage_cost" id="house_damage_cost" onChange="summary_damage()"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextReal13"); ?></span></td>						  
					</tr>
					<tr>
					  <td><?php echo _p("ResourceSub3MoreColumn24");?></td>
					  <td><?php echo _p("ResourceSub3Unit4");?></td>
					  <td><input type="text" class="form-control" name="fence_damage_cost" id="fence_damage_cost" onChange="summary_damage()"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextReal13"); ?></span></td>						  
					</tr>
					<tr>
					  <td><?php echo _p("ResourceSub3MoreColumn25");?></td>
					  <td><?php echo _p("ResourceSub3Unit4");?></td>
					  <td><input type="text" class="form-control" name="car_damage_cost" id="car_damage_cost" onChange="summary_damage()"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextReal13"); ?></span></td>						  
					</tr>
					<tr>
					  <td><?php echo _p("ResourceSub3MoreColumn26");?></td>
					  <td><?php echo _p("ResourceSub3Unit4");?></td>
					  <td><input type="text" class="form-control" name="grass_damage_cost" id="grass_damage_cost" onChange="summary_damage()"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextReal13"); ?></span></td>						  
					</tr>
					<tr>
					  <td><?php echo _p("ResourceSub3MoreColumn27");?></td>
					  <td><?php echo _p("ResourceSub3Unit4");?></td>
					  <td><input type="text" class="form-control" name="other_property_cost" id="other_property_cost" onChange="summary_damage()"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextReal13"); ?></span></td>						  
					</tr>
					<tr>
					  <th>9.</th>
					  ...
					  <td><?php echo _p("ResourceSub3Unit4");?></td>
					  <td><input type="text" disabled class="form-control" name="total_damage_cost" id="total_damage_cost"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextReal13"); ?></span></td>						  
					</tr>
					<tr>
					  <th rowspan="3">10.</th>
					  ...
					  <td><?php echo _p("ResourceSub3Unit1");?></td>
					  <td><input type="text" class="form-control" name="died_people_number" id="died_people_number"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextInt1"); ?> </span></td>	
					</tr>
					<tr>
					  <td><?php echo _p("ResourceSub3MoreColumn30");?></td>
					  <td><?php echo _p("ResourceSub3Unit1");?></td>
					  <td><input type="text" class="form-control" name="burnt_people_number" id="burnt_people_number"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextInt1"); ?> </span></td>	
					</tr>
					<tr>
					  <td><?php echo _p("ResourceSub3MoreColumn31");?></td>
					  <td><?php echo _p("ResourceSub3Unit1");?></td>
					  <td><input type="text" class="form-control" name="affected_people_number" id="affected_people_number"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextInt1"); ?> </span></td>	
					</tr>
					<tr>
					  <th rowspan="3">11.</th>
					  ...
					  <td><?php echo _p("ResourceSub3Unit2");?></td>
					  <td><textarea class="form-control" name="fire_source_human" id="fire_source_human" rows="2"></textarea></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextChar50"); ?></span></td>						  
					</tr>
					<tr>
					  <td><?php echo _p("ResourceSub3MoreColumn33");?></td>
					  <td><?php echo _p("ResourceSub3Unit2");?></td>
					  <td><textarea class="form-control" name="fire_source_natural" id="fire_source_natural" rows="2"></textarea></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextChar50"); ?></span></td>						  
					</tr>
					<tr>
					  <td><?php echo _p("ResourceSub3MoreColumn34");?></td>
					  <td><?php echo _p("ResourceSub3Unit2");?></td>
					  <td><textarea class="form-control" name="fire_source_outside" id="fire_source_outside" rows="2"></textarea></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextChar50"); ?></span></td>						  
					</tr>
					<tr>
					  <th rowspan="7">12.</th>
					  ...
					  <td><?php echo _p("ResourceSub3Unit4");?></td>
					  <td><input type="text" class="form-control" name="damp_food_cost" id="damp_food_cost" onChange="summary_damp()"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextReal13"); ?></span></td>
					</tr>
					<tr>
					  <td><?php echo _p("ResourceSub3MoreColumn36");?></td>
					  <td><?php echo _p("ResourceSub3Unit4");?></td>
					  <td><input type="text" class="form-control" name="damp_petrol_cost" id="damp_petrol_cost" onChange="summary_damp()"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextReal13"); ?></span></td>
					</tr>
					<tr>
					  <td><?php echo _p("ResourceSub3MoreColumn37");?></td>
					  <td><?php echo _p("ResourceSub3Unit4");?></td>
					  <td><input type="text" class="form-control" name="damp_aeroplain_cost" id="damp_aeroplain_cost" onChange="summary_damp()"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextReal13"); ?></span></td>
					</tr>
					<tr>
					  <td><?php echo _p("ResourceSub3MoreColumn38");?></td>
					  <td><?php echo _p("ResourceSub3Unit4");?></td>
					  <td><input type="text" class="form-control" name="damp_salary_cost" id="damp_salary_cost" onChange="summary_damp()"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextReal13"); ?></span></td>
					</tr>
					<tr>
					  <td><?php echo _p("ResourceSub3MoreColumn39");?></td>
					  <td><?php echo _p("ResourceSub3Unit4");?></td>
					  <td><input type="text" class="form-control" name="damp_moving_cost" id="damp_moving_cost" onChange="summary_damp()"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextReal13"); ?></span></td>
					</tr>
					<tr>
					  <td><?php echo _p("ResourceSub3MoreColumn40");?></td>
					  <td><?php echo _p("ResourceSub3Unit4");?></td>
					  <td><input type="text" class="form-control" name="damp_other_cost" id="damp_other_cost" onChange="summary_damp()"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextReal13"); ?></span></td>
					</tr>
					<tr>
					  <td><?php echo _p("ResourceSub3MoreColumn41");?></td>
					  <td><?php echo _p("ResourceSub3Unit4");?></td>
					  <td><input type="text" disabled class="form-control" name="total_damp_cost" id="total_damp_cost"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextReal13"); ?></span></td>
					</tr>
					<tr>
					  <th rowspan="4">13.</th>
					  ...
					  <td><?php echo _p("ResourceSub3Unit4");?></td>
					  <td><input type="text" class="form-control" name="prevention_technics_cost" id="prevention_technics_cost"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextReal13"); ?></span></td>
					</tr>
					<tr>
					  <td><?php echo _p("ResourceSub3MoreColumn43");?></td>
					  <td><?php echo _p("ResourceSub3Unit4");?></td>
					  <td><input type="text" class="form-control" name="prevention_canvass_cost" id="prevention_canvass_cost"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextReal13"); ?></span></td>
					</tr>
					<tr>
					  <td><?php echo _p("ResourceSub3MoreColumn44");?></td>
					  <td><?php echo _p("ResourceSub3Unit4");?></td>
					  <td><input type="text" class="form-control" name="prevention_firewarden_cost" id="prevention_firewarden_cost"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextReal13"); ?></span></td>
					</tr>
					<tr>
					  <td><?php echo _p("ResourceSub3MoreColumn45");?></td>
					  <td><?php echo _p("ResourceSub3Unit4");?></td>
					  <td><input type="text" class="form-control" name="prevention_training_cost" id="prevention_training_cost"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextReal13"); ?></span></td>
					</tr>
					<tr>
					  <th rowspan="3">14.</th>
					  ...
					  <td><?php echo _p("ResourceSub3Unit4");?></td>
					  <td><input type="text" class="form-control" name="prevention_dustbelt_cost" id="prevention_dustbelt_cost"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextReal13"); ?></span></td>
					</tr>
					<tr>
					  <td><?php echo _p("ResourceSub3MoreColumn47");?></td>
					  <td><?php echo _p("ResourceSub3Unit4");?></td>
					  <td><input type="text" class="form-control" name="prevention_burntbelt_cost" id="prevention_burntbelt_cost"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextReal13"); ?></span></td>
					</tr>
					<tr>
					  <td><?php echo _p("ResourceSub3MoreColumn48");?></td>
					  <td><?php echo _p("ResourceSub3Unit4");?></td>
					  <td><input type="text" class="form-control" name="prevention_clearing_cost" id="prevention_clearing_cost"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextReal13"); ?></span></td>
					</tr>
					<tr>
					  <th rowspan="2">15.</th>
					  ...
					  <td><?php echo _p("ResourceSub3Unit4");?></td>
					  <td><input type="text" class="form-control" name="damage_indemnity_put" id="damage_indemnity_put"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextReal13"); ?></span></td>
					</tr>
					<tr>
					  <td><?php echo _p("ResourceSub3MoreColumn50");?></td>
					  <td><?php echo _p("ResourceSub3Unit4");?></td>
					  <td><input type="text" class="form-control" name="damage_indemnity_exhaustive" id="damage_indemnity_exhaustive"/></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextReal13"); ?></span></td>
					</tr>
					<tr>
					  <th>16.</th>
					  ...
					  <td><?php echo _p("ResourceSub3Unit2");?></td>
					  <td><textarea class="form-control" name="causer_address" id="causer_address" rows="3"></textarea></td>
					...
					<tr>
					  ...
					  <td><?php echo _p("ResourceSub3Unit2");?></td>
					  <td><textarea class="form-control" name="provision_causer_crime" id="provision_causer_crime" rows="2"></textarea></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextChar50"); ?></span></td>
					</tr>
					<tr>
					  <td><?php echo _p("ResourceSub3MoreColumn53");?></td>
					  <td><?php echo _p("ResourceSub3Unit2");?></td>
					  <td><textarea class="form-control" name="provision_causer_administrative" id="provision_causer_administrative" rows="2"></textarea></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextChar50"); ?></span></td>
					</tr>
					<tr>
					  <td><?php echo _p("ResourceSub3MoreColumn54");?></td>
					  <td><?php echo _p("ResourceSub3Unit2");?></td>
					  <td><textarea class="form-control" name="provision_causer_fine" id="provision_causer_fine" rows="2"></textarea></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextChar50"); ?></span></td>
					</tr>
					<tr>
					  <th>18.</th>
					  ...
					  <td><?php echo _p("ResourceSub3Unit2");?></td>
					  <td><textarea class="form-control" name="other" id="other" rows="3"></textarea></td>
					  <td><span class="form-text text-muted"><?php echo _p("AlertTextCharAll"); ?></span></td>
					</tr>
				  </tbody>
				</table>
			  </div>			  
			  <input type="hidden" id="insertforestfirebttn" name="insertforestfirebttn" value="0"/>
