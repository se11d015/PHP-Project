...
{
    document.getElementById("insertplantedforestgeombttn").value = "1";
...
<div class="table-responsive">
  <table class="table table-bordered table-striped">
    <thead>
      <tr>
        <th><?php echo _p("AddText5")." "._p("GisSubTitle3")." "._p("AddText6"); ?></th>
      </tr>
    </thead>
    <tbody>
      <tr>
          ...
          <form class="form" action="<?php echo $my_url.$search_url.$sort_url; ?>" enctype="multipart/form-data" method="post" name="mainform" id="mainform">
            ...
            <div class="form-group row">
			 ...
			 <div class="form-group row">
			  ...
			  <input type="hidden" id="insertplantedforestgeombttn" name="insertplantedforestgeombttn" value="0"/>
