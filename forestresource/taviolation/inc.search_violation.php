        ...
        <td><form class="form" role="form" action="<?php echo $my_url; ?>" method="post" name="mainform" id="mainform">
            <div class="form-row">
              <div class="form-group row col-md-6">
                <label class="col-md-5 col-form-label"><?php echo _p("ResourceSub8SearchText1"); ?>:</label>
                <div class="col-md-3">
              ...
              <div class="form-group row col-md-6">
                <label class="col-md-5 col-form-label"><?php echo _p("ResourceSub8SearchText2"); ?>:</label>
                <div class="col-md-5">
                  <?php
					...
					echo seldatadb("saimag_code", "form-control", $rows, "aimag_code", "aimag_name_mn", $saimag_code, "", _p("AllAimags"));
					?>
                </div>
              </div>
            </div>			
            ...
            <div class="form-row">
              <div class="form-group row col-md-10 justify-content-end">
                <button type="submit" class="btn btn-primary" name="searchviolationbttn"><i class="fa fa-search"></i> <?php echo _p("SearchButton"); ?></button>
              </div>
            </div>
          </form></td>
      </tr>
