<div class="content-wrapper">
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col">
        <h1> <?php echo _p("GisSubTitle4"); ?> </h1>
		  <?php
			if ($db->isGroupRole($schemas, $sess_profile, $sess_user_id, 14, 1)) 
			{
				...
				require("tgforestlogging/inc.admin_export_forestlogging.php");
				...
				{
					require("tgforestlogging/inc.select_admin_forestutilization.php");
				}elseif ($action=="export")
				{
					require("tgforestlogging/inc.export_forestlogging.php");
				} elseif ($action == "more")
				{
					require("tgforestlogging/inc.more_forestlogging.php");
				} elseif ($action == "outputgeom")
				{
					require("tgforestlogging/inc.output_forestlogging.php");					
				} else
				{
					require("tgforestlogging/inc.list_forestlogging.php");
				}
			} else {
