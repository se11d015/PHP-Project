<?php
if (isset($_POST["searchforestlogginggeombttn"])) 
{
	$searchQuery = "";
	$search_url = "";
...
if (isset($_GET["sort"])) 
{
	...
	{
        $sortQuery .= " tgf.logging_type";
    } else if ($_GET["sort"] == 5) 
	{
        $sortQuery .= " tgf.logging_area";
    } else
	{
...
$startQuery = "SELECT";
$valueQuery = "COUNT(*) AS num_count FROM ".$schemas.".tgforestlogging tgf, ".$schemas.".taforestutilization taf, scadministrative.vasoumname vs";
...
require("tgforestlogging/inc.search_forestlogging.php");	
...
<div class="table-responsive">
  <table id="forestresource_datatables" class="table table-bordered table-hover" title_name="<?php echo _p("GisSubTitle4"); ?>" file_name="forestlogging" column_name="0, 1, 2, 3, 4, 5, 6, 7" language_name="<?php echo $language_name;?>" page_count="<?php echo $count;?>">
    <thead>
      <tr>
      ...
      <tr>
        <th>№</th>
        <th><a href="<?php echo $my_url."&sort=1&sorttype=".$sorttype.$search_url; ?>" style="color:#FFFFFF"><i class="fa fa-sort"></i> <?php echo _p("GisSub4Column3"); ?></a></th>		
        <th><a href="<?php echo $my_url."&sort=2&sorttype=".$sorttype.$search_url; ?>" style="color:#FFFFFF"><i class="fa fa-sort"></i> <?php echo _p("GisSub4Column1"); ?></a></th>
        <th><a href="<?php echo $my_url."&sort=3&sorttype=".$sorttype.$search_url; ?>" style="color:#FFFFFF"><i class="fa fa-sort"></i> <?php echo _p("GisSub4Column2"); ?></a></th>
        <th><a href="<?php echo $my_url."&sort=4&sorttype=".$sorttype.$search_url; ?>" style="color:#FFFFFF"><i class="fa fa-sort"></i> <?php echo _p("GisSub4Column4"); ?></a></th>
        <th><a href="<?php echo $my_url."&sort=5&sorttype=".$sorttype.$search_url; ?>" style="color:#FFFFFF"><i class="fa fa-sort"></i> <?php echo _p("GisSub4Column5").", ". _p("GisSub4Unit2"); ?></a></th>
        <th><a href="<?php echo $my_url."&sort=6&sorttype=".$sorttype.$search_url; ?>" style="color:#FFFFFF"><i class="fa fa-sort"></i> <?php echo _p("GisSub4Column6").", ". _p("GisSub4Unit3"); ?></a></th>
    ...
    <tbody>
      <?php
		...
		taf.utilization_year, vs.aimag_name_mn, vs.aimag_name_en, vs.soum_name_mn, vs.soum_name_en FROM ".$schemas.".tgforestlogging tgf, ".$schemas.".taforestutilization taf, scadministrative.vasoumname vs";
		$whereQuery = "WHERE tgf.utilization_id = taf.utilization_id AND taf.soum_code = vs.soum_code";
      ...
      <tr>
        ...
        <td><?php if($rows[$i]["logging_type"]==1) echo _p("GisSub4MoreColumn1"); 
			else if($rows[$i]["logging_type"]==2) echo _p("GisSub2MoreColumn2");
			else if($rows[$i]["logging_type"]==3) echo _p("GisSub2MoreColumn3"); ?></td>
        <td><?php echo $rows[$i]["logging_area"]; ?></td>
        <td><?php echo $rows[$i]["logged_total"]; ?></td>
        <td><?php 
