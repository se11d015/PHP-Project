...
<div class="more-table">
    ...
    <div class="accordion-group">
      ...
      <div id="collapse2" class="accordion-body collapse in">
        <div class="accordion-inner">
          <?php
			require("taanimalresearchreport/inc.query_animalresearchreportform.php");
			?>
        </div>
      </div>
    </div>
            ...
            <tbody>
              <?php
				...
				for ($i=0; $i < sizeof($row); $i++) 
				{
					...
					require("taanimalresearchreport/inc.query_animalresearchbudgetform.php");
				}
				?>
              <tr>
                <th>Нийт дүн</th>
  ...
  <div>
    <?php
		...
		{
		?>
    <a class="btn btn-danger" href="<?php echo $my_url.$my_page.$search_url.$sort_url."&action=edit&research_id=".$research_id; ?>"><i class="icon-edit icon-white"></i>&nbsp;Засварлах</a>&nbsp;
    <?php 
