...
require("inc.search_animalprotectionform.php");
...
<div class="list-table">
  <table class="table table-bordered table-striped table-hover">
    <thead>
      <tr>
        <th colspan="8"><span class="title"><?php echo getdata($ITEM_TYPE, 50); ?></span></th>
      </tr>
    </thead>
    <thead>
      <tr>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td align="center"><a href="<?php echo $my_url.$my_page.$search_url.$sort_url."&action=more&protect_id=".$rows[$i]["protect_id"]; ?>" title="Дэлгэрэнгүй харах"><i class="icon-list"></i></a>
          <?php 
				if($sess_profile==1)
				{ 
				?>
          <a href="<?php echo $my_url.$my_page.$search_url.$sort_url."&action=edit&protect_id=".$rows[$i]["protect_id"]; ?>" title="Засварлах"><i class="icon-edit"></i></a> <a href="<?php echo $my_url.$search_url.$sort_url."&action=delete&protect_id=".$rows[$i]["protect_id"]; ?>" title="Устгах" onClick="return confirm('Та устгахдаа итгэлтэй байна уу?');"><i class="icon-trash"></i></a> <a href="<?php echo $my_url.$my_page.$search_url.$sort_url."&action=animaladd&protect_id=".$rows[$i]["protect_id"]; ?>" title="Ургамал хамгаалах арга хэмжээ авсан ургамал нэмэх"><i class="icon-plus-sign"></i></a> <a href="<?php echo $my_url.$my_page.$search_url.$sort_url."&action=expenseadd&protect_id=".$rows[$i]["protect_id"]; ?>" title="Зардлын мэдээлэл нэмэх"><i class="icon-plus"></i></a>
          <?php 
