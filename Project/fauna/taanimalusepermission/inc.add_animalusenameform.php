        ...
        <td><form class="form-horizontal" action="<?php echo $my_url . $search_url . $sort_url; ?>" enctype="multipart/form-data" method="post" name="mainform" id="mainform">
            <div class="control-group">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <?php
					$selQuery = "SELECT tgcen.entity_id, tgcen.entity_name FROM scfauna.taanimalusepermission tgcpe, scfauna.tganimaluseentity tgcen WHERE tgcpe.entity_name=tgcen.entity_id AND tgcpe.permission_id=".$permission_id." ORDER BY tgcen.entity_name ASC";
