<?php
   ...
   if(empty($species_name_mn))
    ...
    if ($action == "output") {
        ...
        require("includes/taanimalusepermission/inc.more_animalusepermission.php");
    }  elseif ($action == "paymentmore") {
        require("includes/taanimalusepermission/inc.more_animalusepayment.php");
    } else {
        require("includes/taanimalusepermission/inc.list_animalusepermission.php");
    }
?>
