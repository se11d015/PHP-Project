...
if (!empty($row)) {
    if ($outputtype == 1 || $outputtype == 2) {
        ...
        $buffer .= "Судалгаа хийсэн он: " . $row[$i]["evaluated_date"] . "\r\n";
        $buffer .= "Тархацын зургийг хийсэн он: " . $row[$i]["gyear"] . "\r\n";
        $buffer .= "Тархацын зургийн хийсэн байгууллагын нэр: " . $row[$i]["org_name"] . "\r\n";
    ...
    if ($outputtype == 3) {
        ...
        header('Content-Disposition: attachment; filename="plantresourcelocation.kml"');
        ob_clean();
        flush();
        echo $kmlOutput;
        exit;
