...
FROM " . $schemas . ".takingdomname takn, ".$schemas.".taanimalcustompermission tgcpe, ".$schemas.".tganimalcustomentity tgcen, ".$schemas.".taanimalcustomname tgcna," . $schemas . ".taphylumname tapn," . $schemas . ".taclassname tacn, " . $schemas . ".tafamilyname tafn," . $schemas . ".taordername taon," . $schemas . ".tagenusname tagn," . $schemas . ".taanimalname tapl ";
...
<div class="more-table">
  <table class="table table-bordered table-striped table-hover">
    <thead>
      <tr>
        <th colspan="2"><?php echo getdata($ITEM_TYPE, 62); ?> дэлгэрэнгүй харах</th>
      </tr>
    </thead>
    <tbody>
      <tr>
