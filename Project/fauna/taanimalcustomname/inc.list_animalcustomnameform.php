<?php
if (isset($_POST["searchanimalcustomentitybttn"]))
{
	$searchQuery = "";
	$search_url = "";
...
$startQuery = "SELECT";
$valueQuery = " COUNT(*) AS num_count   FROM ".$schemas.".taanimalcustompermission tgcpe, ".$schemas.".tganimalcustomentity tgcen, ".$schemas.".taanimalcustomname tgcna,".$schemas.".takingdomname takn,".$schemas.".taphylumname tadn,".$schemas.".taclassname tacn,".$schemas.".taordername taon,".$schemas.".tafamilyname tafn,".$schemas.".tagenusname tagn,".$schemas.".taanimalname taan";
$whereQuery = "WHERE tgcpe.entity_name = tgcen.entity_id  AND tgcpe.permission_id = tgcna.permission_id AND tgcna.species_name = taan.species_code AND taan.genus_code = tagn.genus_code AND tagn.family_code = tafn.family_code AND tafn.order_code = taon.order_code AND taon.class_code=tacn.class_code AND tacn.phylum_code=tadn.phylum_code  AND tadn.kingdom_code=takn.kingdom_code";
...
require("inc.search_animalcustomnameform.php");
...
<div class="list-table">
  <table class="table table-bordered table-hover">
    <thead>
      <tr>
        <th colspan="8"><span class="title"><?php echo getdata($ITEM_TYPE, 62); ?></span></th>
      </tr>
    </thead>
    <thead>
      <tr>
        <td>№</td>
        <th class="span6"><a href="<?php echo $my_url."&sort=1&sorttype=".$sorttype.$search_url; ?>" style="color:#FFFFFF"><i class="icon-tag icon-white"></i>Экспортлогч, импортлогчийн нэр</a></th>
    ...
    <tbody>
      <?php
		...
		$startQuery = "SELECT";
		$valueQuery = "tgcna.*, tgcpe.*, tgcen.entity_name, tagn.genus_name, tagn.genus_name_mn, tadn.phylum_name_mn, taon.order_name_mn, tafn.family_name_mn,  taan.species_name_mn,taan.species_name  FROM ".$schemas.".taanimalcustompermission tgcpe, ".$schemas.".tganimalcustomentity tgcen, ".$schemas.".taanimalcustomname tgcna,".$schemas.".takingdomname takn,".$schemas.".taphylumname tadn,".$schemas.".taclassname tacn,".$schemas.".taordername taon,".$schemas.".tafamilyname tafn,".$schemas.".tagenusname tagn,".$schemas.".taanimalname taan";
		$whereQuery = "WHERE tgcpe.entity_name = tgcen.entity_id  AND tgcpe.permission_id = tgcna.permission_id AND tgcna.species_name = taan.species_code AND taan.genus_code = tagn.genus_code AND tagn.family_code = tafn.family_code AND tafn.order_code = taon.order_code AND taon.class_code=tacn.class_code AND tacn.phylum_code=tadn.phylum_code  AND tadn.kingdom_code=takn.kingdom_code";
      ...
      <tr>
        ...
        <td><?php echo $rows[$i]["species_amount"]; ?></td>
        ...
        <td align="center"><a href="<?php echo $my_url.$my_page.$search_url.$sort_url."&action=more&species_id=".$rows[$i]["species_id"]; ?>" title="Дэлгэрэнгүй харах"><i class="icon-list"></i></a>
          <?php
				...
				{
				?>
          <a href="<?php echo $my_url.$my_page.$search_url.$sort_url."&action=edit&species_id=".$rows[$i]["species_id"]; ?>"><i class="icon-edit"></i></a> <a href="<?php echo $my_url.$search_url.$sort_url."&action=delete&species_id=".$rows[$i]["species_id"]; ?>" title="Устгах" onClick="return confirm('Та устгахдаа итгэлтэй байна уу?');"><i class="icon-trash"></i></a>
          <?php 
