...
function addsubmitform()
{
	if (document.getElementById("genus_code").value==""){
		...
		document.getElementById("insertspeciesbttn").value = "1";
...
<div class="add-table">
  <table class="table table-bordered table-condensed">
    <thead>
      <tr>
        <th><?php echo getdata($ITEM_TYPE, 7); ?> бүртгэх хэсэг</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td><form class="form-horizontal" action="<?php echo $my_url.$search_url.$sort_url; ?>" enctype="multipart/form-data" method="post" name="mainform" id="mainform">
            <div class="control-group">
              ...
              <div class="controls">
                <?php
					...
					echo seldatadb("phylum_code_genus", "span4", $rows, "phylum_code", "phylum_name", $rows[0]["phylum_code"]);
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <?php
					...
					$rows = $db->query($selQuery);
					echo seldatadb("order_code_genus", "span4", $rows, "order_code", "order_name", $rows[0]["order_code"]);
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span2" name="species_code" id="species_code"/>
                <span class="help-inline">Бүхэл тоо байна.</span> </div>
            </div>
            <div class="control-group">
              <label class="control-label">Зүйлийн латин нэр:</label>
              <div class="controls">
                <input type="text" class="span5" name="species_name" id="species_name"/>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span5" name="species_name_mn" id="species_name_mn"/>
                <span class="help-inline">150 тэмдэгтээс хэтэрч болохгүй.</span> </div>
            </div>
            <div class="control-group">
              <label class="control-label">Зүйлийн англи нэр:</label>
              <div class="controls">
                <input type="text" class="span5" name="species_name_en" id="species_name_en"/>
                <span class="help-inline">150 тэмдэгтээс хэтэрч болохгүй.</span> </div>
            </div>
            <div class="control-group">
              <label class="control-label">Зүйлийн орос нэр:</label>
              <div class="controls">
                <input type="text" class="span5" name="species_name_ru" id="species_name_ru"/>
                <span class="help-inline">150 тэмдэгтээс хэтэрч болохгүй.</span> </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span3" name="taxonid" id="taxonid"/>
                <span class="help-inline">25 тэмдэгтээс хэтэрч болохгүй.</span> </div>
            </div>
            <div class="control-group">
              <label class="control-label">Олон улсын BARCODE дугаар:</label>
              <div class="controls">
                <input type="text" class="span3" name="barcode" id="barcode"/>
                <span class="help-inline">25 тэмдэгтээс хэтэрч болохгүй.</span> </div>
            </div>
            <input type="hidden" id="insertspeciesbttn" name="insertspeciesbttn" value="0"/>
