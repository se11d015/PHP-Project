...
$startQuery = "SELECT";
$valueQuery = "COUNT(*) AS num_count   FROM ".$schemas.".tganimalcustomentity tgcen, scadministrative.taaimagname taaim, scadministrative.tasoumname tasou ";
$whereQuery = "WHERE tgcen.entity_id = tgcen.entity_id AND taaim.aimag_code=tgcen.aimag_name  AND tasou.soum_code=tgcen.soum_name";
...
require("inc.search_animalcustomentityform.php");
...
<div class="list-table">
  <table class="table table-bordered table-striped table-hover">
    <thead>
      <tr>
        <th colspan="8"><span class="title"><?php echo getdata($ITEM_TYPE, 60); ?></span></th>
      </tr>
    </thead>
    <thead>
      <tr>
        ...
        <th class="span4"><a href="<?php echo $my_url."&sort=4&sorttype=".$sorttype.$search_url; ?>" style="color:#FFFFFF"><i class="icon-tag icon-white"></i> Экспортлогч, импортлогчийн нэр</a></th>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><?php echo getdata($CUSTOM_ENTITY_TYPE, $rows[$i]["entity_type"]); ?></td>
