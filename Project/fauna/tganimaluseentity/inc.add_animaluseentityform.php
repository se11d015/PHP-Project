...
function addsubmitform()
{
 	if (document.getElementById("entity_name").value == "") {
		...
		document.getElementById("insertanimaluseentitybttn").value = "1";
...
<div class="add-table">
  <table class="table table-bordered table-condensed">
    <thead>
      <tr>
        <th><?php echo getdata($ITEM_TYPE, 70); ?> бүртгэх хэсэг</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td><form class="form-horizontal" action="<?php echo $my_url . $search_url . $sort_url; ?>" enctype="multipart/form-data" method="post" name="mainform" id="mainform">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <?php
					echo seldata("entity_type", "span2", $USE_ENTITY_TYPE, 1);
					?>
                <span class="help-inline">Жагсаалтаас аль нэгийг нь сонгоно.</span> </div>
            </div>
            <div class="control-group">
            ...
            <input type="hidden" id="insertanimaluseentitybttn" name="insertanimaluseentitybttn" value="0"/>
