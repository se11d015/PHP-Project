    ...
    <tbody>
      <tr>
        <td><form class="form-horizontal" action="<?php echo $my_url . $search_url . $sort_url; ?>" enctype="multipart/form-data" method="post" name="mainform" id="mainform">
            <input type="hidden" name="entity_name" id="entity_name" value="<?php echo $entity_id; ?>">
            <div class="control-group">
              <label class="control-label">Нөөц ашиглагчийн нэр:</label>
              <div class="controls">
                <?php
					$selQuery = "SELECT tgcen.entity_id, tgcen.entity_name FROM ".$schemas.".tganimaluseentity tgcen WHERE tgcen.entity_id = ".$entity_id." ORDER BY tgcen.entity_name ASC";
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <?php
					echo seldata("permission_type", "span2", $USE_PERMISSION_TYPE, 1);
					?>
