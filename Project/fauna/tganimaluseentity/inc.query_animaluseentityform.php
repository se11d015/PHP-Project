<div class="more-table">
  <table class="table table-bordered table-striped table-hover">
    <thead>
      <tr>
        <th colspan="2"><?php echo getdata($ITEM_TYPE, 70); ?> дэлгэрэнгүй харах</th>
      </tr>
    </thead>
    <tbody>
      <tr>
      ...
      <tr>
        ...
        <td><?php echo getdata($USE_ENTITY_TYPE, $row[$i]["entity_type"]); ?></td>
      </tr>
      <tr>
      ...
      <tr>
        <td class="span4"><strong>Нөөц ашиглагчийн  регистрийн дугаар:</strong></td>
