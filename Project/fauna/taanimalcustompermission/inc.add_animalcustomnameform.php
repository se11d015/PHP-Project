        ...
        <td><form class="form-horizontal" action="<?php echo $my_url . $search_url . $sort_url; ?>" enctype="multipart/form-data" method="post" name="mainform" id="mainform">
            <div class="control-group">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <?php
					$selQuery = "SELECT tgcen.entity_id, tgcen.entity_name FROM scfauna.taanimalcustompermission tgcpe, scfauna.tganimalcustomentity tgcen WHERE tgcpe.entity_name=tgcen.entity_id AND tgcpe.permission_id=".$permission_id." ORDER BY tgcen.entity_name ASC";
					$rows = $db->query($selQuery);						;
					echo getdatadb($rows, "entity_id", "entity_name", $rows[0]["entity_id"]);
					?>
                </div>
              </div>
              <div class="control-group">
                ...
                <div class="controls">
                  <?php
					$selQuery = "SELECT tgcpe.permission_id, tgcpe.permission_number FROM scfauna.taanimalcustompermission tgcpe WHERE tgcpe.permission_id=".$permission_id." ORDER BY tgcpe.permission_number ASC";
					$rows = $db->query($selQuery);						;
