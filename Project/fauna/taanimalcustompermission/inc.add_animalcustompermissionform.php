      ...
      <tr>
        <td><form class="form-horizontal" action="<?php echo $my_url . $search_url . $sort_url; ?>" enctype="multipart/form-data" method="post" name="mainform" id="mainform">
            <div class="control-group">
              ...
              <div class="controls">
                <?php
					...
					if(!empty($rows))
						echo seldatadb("entity_id", "span4", $rows, "entity_id", "entity_name", $rows[0]["entity_id"]);
					else 
						echo seldatadb("entity_id", "span4", $rows, "entity_id", "entity_name", NULL);		
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <?php
					echo seldata("permission_type", "span2", $CUSTOM_PERMISSION_TYPE, 0);
					?>
