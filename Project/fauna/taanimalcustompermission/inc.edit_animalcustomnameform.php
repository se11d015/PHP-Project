...
if ($db->isGroupRole($schemas, $sess_profile, $sess_user_id, 6, 2)) 
{
	...
	$startQuery = "SELECT";
	$valueQuery = "tgcpe.*, tgcna.*, tgcen.entity_name, tapl.species_code, takn.kingdom_name, takn.kingdom_name_mn, takn.kingdom_name_en, takn.kingdom_name_ru, tapn.phylum_name, tapn.phylum_name_mn, tapn.phylum_name_en, tapn.phylum_name_ru, tacn.class_name, tacn.class_name_mn, tacn.class_name_en, tacn.class_name_ru, taon.order_name, taon.order_name_mn, taon.order_name_en, taon.order_name_ru, tafn.family_name, tafn.family_name_mn, tafn.family_name_en, tafn.family_name_ru, tagn.genus_name, tagn.genus_name_mn, tagn.genus_name_en, tagn.genus_name_ru, tapl.species_name, tapl.species_name_mn,  tapl.species_name_en, tapl.species_name_ru FROM " . $schemas . ".takingdomname takn," . $schemas . ".taphylumname tapn," . $schemas . ".taclassname tacn," . $schemas . ".tafamilyname tafn," . $schemas . ".taordername taon," . $schemas . ".tagenusname tagn," . $schemas . ".taanimalname tapl, " . $schemas . ".taanimalcustomname tgcna, ".$schemas.".tganimalcustomentity tgcen, ".$schemas.".taanimalcustompermission tgcpe";
...
function updatesubmitform()
{
	if (document.getElementById("species_code").value==""){
		...
		document.getElementById("updateanimalcustomnamebttn").value = "1";
...
<div class="add-table">
  <table class="table table-bordered table-condensed">
    <thead>
      <tr>
        <th><?php echo getdata($ITEM_TYPE, 62); ?> засах хэсэг</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td><form class="form-horizontal" action="<?php echo $my_url . $search_url . $sort_url; ?>" enctype="multipart/form-data" method="post" name="mainform" id="mainform">
            ...
            <div class="control-group">
              <label class="control-label">Амьтны нөөц ашиглагчийн нэр:</label>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span3" name="species_amount" id="species_amount" value="<?php echo $row[$i]["species_amount"]; ?>"/>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <textarea name="species_info" id="species_info" rows="3" class="span5"><?php echo $row[$i]["species_info"]; ?></textarea>
                <span class="help-inline">Тэмдэгтийн тоо хязгааргүй.</span> </div>
            </div>
            <input type="hidden" id="updateanimalcustomnamebttn" name="updateanimalcustomnamebttn" value="0"/>
