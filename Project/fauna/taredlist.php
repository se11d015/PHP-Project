<?php
   ...
   if(empty($species_name_mn))
	...
	if ($action=="more")
	{
		require("includes/taredlist/inc.more_redlist.php");
	}elseif($action=="alphabet_mn")
	{
		require("includes/taredlist/inc.list_redlist_alphabet_mn.php");
		
	}elseif($action=="alphabet_en")
	{
		require("includes/taredlist/inc.list_redlist_alphabet_en.php");
		
	} else
	{
		require("includes/taredlist/inc.list_redlist.php");
	}
