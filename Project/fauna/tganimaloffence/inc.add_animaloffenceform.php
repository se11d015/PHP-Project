...
<script language="JavaScript" type="text/javascript">
    ...
    {
        if (document.getElementById("offence_date").value == "") {
            alert("Зураг авсан огноог оруулна уу");
        } else {
            document.getElementById("insertoffencebttn").value = "1";
...
<div class="add-table">
  <table class="table table-bordered table-condensed">
    <thead>
      <tr>
        <th><?php echo getdata($ITEM_TYPE, 100); ?> бүртгэх хэсэг</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td><form class="form-horizontal" action="<?php echo $my_url . $search_url . $sort_url; ?>" enctype="multipart/form-data" method="post" name="mainform" id="mainform">
         <div class="control-group">
          ...
          <div class="control-group ">
            ...
            <div class="controls">
              <input type="text" name="offense_amount" id="offense_amount" class="span2"/>
          ...
          <div class="control-group">
              ...
              <div class="controls">
                <?php
					echo seldata("amount_unit", "span2", $OFFENCE_TYPE, 0);
					?>
          ...
          <div class="control-group ">
            ...
            <div class="controls">
              <input type="text" name="penalty_payment" id="penalty_payment" class="span4"/>
          ...
          <div class="control-group ">
            ...
            <div class="controls">
              <input type="text" name="recovery_payment" id="recovery_payment" class="span4"/>
			   <span class="help-inline">15 орноос хэтрэхгүй бутархай тоо байна. </span> </div>
          </div>
          <div class="control-group ">
            ...
            <input type="hidden" id="insertoffencebttn" name="insertoffencebttn" value="0"/>
