...
tagn.genus_code, tagn.genus_name, tagn.genus_name_mn, tagn.genus_name_en, tagn.genus_name_ru, tapl.species_name, 
...
<div>
  <?php
                    if ($sess_profile == 1) {
                        ?>
  <a class="btn btn-danger" href="<?php echo $my_url . $my_page . $search_url . $sort_url . "&action=edit&offence_id=" . $row[$i]["offence_id"]; ?>"><i class="icon-edit icon-white"></i>&nbsp;Засварлах</a>&nbsp;
  <?php
