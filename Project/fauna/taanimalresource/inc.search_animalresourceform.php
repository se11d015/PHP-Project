    ...
    <form class="form-horizontal" action="<?php echo $my_url; ?>" method="post" name="mainform" id="mainform">
      ...
      <div class="span6 search-control">
        ...
        <div class="control-group info">
          ...
          <div class="controls">
            <input type="text" class="span1" name="evaluated_date" id="evaluated_date" value="<?php  if($evaluated_date > 0) echo $evaluated_date;?>"/>
          </div>
        </div>
      </div>
      <div class="span12 offset8">
        <div class="control-group info">
          <div class="controls">
            <button type="submit" class="btn btn-danger" name="searchanimalresourcebttn"><i class="icon-search icon-white"></i>&nbsp;Хайх</button>
          </div>
        </div>
      </div>
    </form>
