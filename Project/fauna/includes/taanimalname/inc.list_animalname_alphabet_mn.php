<div class="list-table">
  ...
  <?php
	...
	$startQuery = "SELECT";
	$valueQuery = "tapl.species_id, tapl.species_name_mn animal_name_mn FROM ".$schemas.".taanimalname tapl, ".$schemas.".tagenusname tagn";
	$whereQuery = "WHERE tapl.genus_code = tagn.genus_code ORDER BY animal_name_mn";
  ...
  <div class="home-button">
    ...
    <?php		
			...
			{           
				...
				{
			?>
    <a href="<?php echo $my_url.$my_page."&action=more&species_id=".$rows[$i]["species_id"]; ?>" title="Дэлгэрэнгүй харах"><?php echo $rows[$i]["animal_name_mn"]; ?></a><br>
    <?php
				}
			}
		?>
