...
<div class="more-table">
  <table class="table table-bordered table-striped table-hover">
    ...
    <tbody>
      ...
      <?php if(!empty($row[$i]["genus_citation_author"]) && !empty($row[$i]["genus_citation_year"])) { ?>
      <tr>
