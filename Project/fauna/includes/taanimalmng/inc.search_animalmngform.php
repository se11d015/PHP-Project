	     ...
	     <div class="control-group info">
          ...
          <div class="controls">
            <?php
				...
				echo seldatadb("type_id", "span2", $row, "type_id", "type_name", "", "", "Бүх төрөл");
				?>
          </div>
        </div>
		 <div class="control-group info">
          ...
          <div class="controls">
            <input type="text" class="span2" name="doc_date" id="doc_date" value="<?php if($doc_date > 0) echo $doc_date;?>"/>
          </div>
        </div>
		 <div class="control-group info">
          <div class="controls">
