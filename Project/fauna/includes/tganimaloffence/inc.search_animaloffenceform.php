      ...
      <div class="span5 search-control">
		...
		<div class="control-group info">
		 ...
		 <div class="control-group info">
          ...
          <div class="controls">
            <input type="text" class="span1" name="offence_date" id="offence_date" value="<?php if($offence_date > 0) echo $offence_date;?>"/>
          </div>
        </div>
		 <div class="control-group info">
          <div class="controls">
            <button type="submit" class="btn btn-danger" name="searchoffencebttn"><i class="icon-search icon-white"></i>&nbsp;Хайх</button>
          </div>
        </div>
      </div>
    </form>
