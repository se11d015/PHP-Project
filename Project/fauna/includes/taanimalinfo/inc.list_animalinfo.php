<?php
if (isset($_POST["searchanimalinfobttn"]))
{
...
$startQuery = "SELECT";
$valueQuery = "COUNT(*) AS num_count FROM ".$schemas.".taanimalinfo tapi,".$schemas.".takingdomname takn,".$schemas.".taphylumname tapn,".$schemas.".taclassname tacn,".$schemas.".tafamilyname tafn,".$schemas.".taordername taon,".$schemas.".tagenusname tagn,".$schemas.".taanimalname tapl";
$whereQuery = "WHERE tapi.basic_id = tapi.basic_id AND tapi.species_code = tapl.species_code AND tapl.genus_code = tagn.genus_code AND tagn.family_code = tafn.family_code AND tafn.order_code = taon.order_code AND taon.class_code=tacn.class_code AND tacn.phylum_code=tapn.phylum_code  AND tapn.kingdom_code=takn.kingdom_code";
...
<div class="list-table">
  <table class="table table-bordered">
    <thead>
      <tr>
        <th><span class="title"><?php echo getdata($ITEM_TYPE, 10); ?></span></th>
      </tr>
    </thead>
  </table>
  <?php 
	require("includes/taanimalinfo/inc.search_animalinfo.php");
  ...
  <table class="table table-bordered table-striped table-hover">
    ...
    <tbody>
      <?php
		...
		$startQuery = "SELECT";
		$valueQuery = "tapi.*, tacn.class_name_mn, tafn.family_name_mn, taon.order_name_mn,  tagn.genus_name, tagn.genus_name_mn, tapl.species_name_mn, tapl.species_name  FROM ".$schemas.".taanimalinfo tapi,".$schemas.".takingdomname takn,".$schemas.".taphylumname tapn,".$schemas.".taclassname tacn,".$schemas.".tafamilyname tafn,".$schemas.".taordername taon,".$schemas.".tagenusname tagn,".$schemas.".taanimalname tapl";
		$whereQuery = "WHERE tapi.basic_id = tapi.basic_id AND tapi.species_code = tapl.species_code AND tapl.genus_code = tagn.genus_code AND tagn.family_code = tafn.family_code AND tafn.order_code = taon.order_code AND taon.class_code=tacn.class_code AND tacn.phylum_code=tapn.phylum_code  AND tapn.kingdom_code=takn.kingdom_code";
      ...
      <tr>
        ...
        <td align="center"><a href="<?php echo $my_url.$my_page.$search_url.$list_url.$sort_url."&action=more&basic_id=".$rows[$i]["basic_id"]."&species_code=".$rows[$i]["species_code"]; ?>" title="Дэлгэрэнгүй харах"><i class="icon-list"></i></a></td>
      </tr>
      <?php 
		}		
		?>
  ...
  <?php 
    ...
    <tbody>
      <?php
		...
		$startQuery = "SELECT";
		$valueQuery = "tapi.*, tacn.class_name, tafn.family_name, taon.order_name,  tagn.genus_name, tapl.species_name, tapl.species_name  FROM ".$schemas.".taanimalinfo tapi,".$schemas.".takingdomname takn,".$schemas.".taphylumname tapn,".$schemas.".taclassname tacn,".$schemas.".tafamilyname tafn,".$schemas.".taordername taon,".$schemas.".tagenusname tagn,".$schemas.".taanimalname tapl";
		$whereQuery = "WHERE tapi.basic_id = tapi.basic_id AND tapi.species_code = tapl.species_code AND tapl.genus_code = tagn.genus_code AND tagn.family_code = tafn.family_code AND tafn.order_code = taon.order_code AND taon.class_code=tacn.class_code AND tacn.phylum_code=tapn.phylum_code  AND tapn.kingdom_code=takn.kingdom_code";
