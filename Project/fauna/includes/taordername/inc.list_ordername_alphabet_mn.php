  ...
  <div class="home-button">
    ...
    <?php		
			...
			{           
				...
				{
			?>
    <a href="<?php echo $my_url.$my_page."&action=more&order_id=".$rows[$i]["order_id"]; ?>" title="Дэлгэрэнгүй харах"><?php echo $rows[$i]["order_name_mn"]; ?></a><br>
    <?php
				}
			}
		?>
