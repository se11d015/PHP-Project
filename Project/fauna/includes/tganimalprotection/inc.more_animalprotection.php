    ...
    <div class="accordion-group">
      ...
      <div id="collapse1" class="accordion-body collapse in">
        <div class="accordion-inner">
          <?php
			require("includes/tganimalprotection/inc.query_animalprotection.php");
			?>
        </div>
      </div>
    </div>
        ...
        <div class="accordion-inner">
            ...
            <tbody>
              <?php	 
				...
				{
				require("includes/tganimalprotection/inc.query_animalprotectname.php");
            ...
            <tbody>
              <?php
				...
				for ($i=0; $i < sizeof($row); $i++) 
				{
					...
					require("includes/tganimalprotection/inc.query_animalprotectexpense.php");
				}
				?>
              <tr>
                <th>Нийт дүн</th>
