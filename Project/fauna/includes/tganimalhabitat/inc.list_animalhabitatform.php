...
<div class="list-table">
  <table class="table table-bordered">
    <thead>
      <tr>
        <th><span class="title"><?php echo getdata($ITEM_TYPE, 13); ?></span></th>
      </tr>
    </thead>
  </table>
  <?php 
require("includes/tganimalhabitat/inc.search_animalhabitatform.php");
    ...
    <thead>
      <tr>
       ...
       <th class="span4"><a href="<?php echo $my_url."&sort=1&sorttype=".$sorttype.$search_url.$list_url; ?>" style="color:#FFFFFF"><i class="  icon-tag icon-white"></i> Ангийн монгол нэр</a></th>
        ...
        <th class="span5"><a href="<?php echo $my_url."&sort=5&sorttype=".$sorttype.$search_url.$list_url; ?>" style="color:#FFFFFF"><i class="  icon-tag icon-white"></i> Амьтны монгол нэр</a></th>
	   <th class="span5">Тархацын зургийг хийсэн он</th>
        <th class="span2"></th>
      </tr>
    </thead>
    <tbody>
   ...
   <?php 
    ...
    <thead>
      <tr>
       ...
       <th class="span4"><a href="<?php echo $my_url."&sort=11&sorttype=".$sorttype.$search_url.$list_url; ?>" style="color:#FFFFFF"><i class="  icon-tag icon-white"></i> Ангийн латин нэр</a></th>
        ...
        <th class="span5"><a href="<?php echo $my_url."&sort=15&sorttype=".$sorttype.$search_url.$list_url; ?>" style="color:#FFFFFF"><i class="  icon-tag icon-white"></i> Амьтны латин нэр</a></th>
	   <th class="span5">Тархацын зургийг хийсэн он</th>
        <th class="span2"></th>
      </tr>
    </thead>
    <tbody>
      <?php
		...
		$limit = $count." OFFSET ".($page-1)*$count;
		$startQuery = "SELECT ";
		$valueQuery = "taaht.*, tacn.class_name, tafn.family_name, taon.order_name, tapl.species_name  FROM ".$schemas.".tganimalhabitat taaht,".$schemas.".takingdomname takn,".$schemas.".taphylumname tapn,".$schemas.".taclassname tacn,".$schemas.".tafamilyname tafn,".$schemas.".taordername taon,".$schemas.".tagenusname tagn,".$schemas.".taanimalname tapl";
		$whereQuery = "WHERE taaht.gid = taaht.gid AND taaht.species_code = tapl.species_code AND tapl.genus_code = tagn.genus_code AND tagn.family_code = tafn.family_code AND tafn.order_code = taon.order_code AND taon.class_code=tacn.class_code AND tacn.phylum_code=tapn.phylum_code  AND tapn.kingdom_code=takn.kingdom_code";
