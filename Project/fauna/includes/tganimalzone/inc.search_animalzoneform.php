    ...
    <form class="form-horizontal" action="<?php echo $my_url; ?>" method="post" name="mainform" id="mainform">
      ...
      <div class="span4 search-control">
        ...
        <div class="control-group info">
          ...
          <div class="controls">
            <input type="text" class="span2" name="aimag_name_mn" id="aimag_name_mn" value="<?php echo $aimag_name_mn;?>"/>
          </div>
        </div>
		<div class="control-group info">
          <label class="control-label">Сумын нэр:</label>
          <div class="controls">
            <input type="text" class="span2" name="soum_name_mn" id="soum_name_mn" value="<?php echo $soum_name_mn;?>"/>
          </div>
        </div>
      </div>
      <div class="span5 search-control">
	    <div class="control-group info">
          ...
          <div class="controls">
            <input type="text" class="span2" name="species_names" id="species_names" value="<?php echo $species_names;?>"/>
          </div>
        </div>
        <div class="control-group info">
          <label class="control-label">Бүсийн нэр:</label>
          <div class="controls">
            <input type="text" class="span2" name="zone_name" id="zone_name" value="<?php echo $zone_name;?>"/>
          </div>
        </div>
		<div class="control-group info">
          <label class="control-label">Бүсийн  зургийг хийсэн он:</label>
          <div class="controls">
            <input type="text" class="span2" name="zone_year" id="zone_year" value="<?php  if($zone_year > 0) echo $zone_year;?>"/>
          </div>
        </div>	
        <div class="control-group info">
          <div class="controls">
