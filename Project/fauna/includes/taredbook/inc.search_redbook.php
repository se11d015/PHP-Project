  ...
  <div class="row">
    <form class="form-horizontal" action="<?php echo $my_url; ?>" method="post" name="mainform" id="mainform">
      ...
      <div class="span5 search-control">
       ...
       <div class="control-group info">
        ...
        <div class="control-group info">
          ...
          <div class="controls">
            <?php
				echo seldata("species_status", "span2", $RB_SPECIES_STATUS,"", "", "Бүх статус");
				?>
          </div>
        </div>
      </div>
      <div class="span9 offset5">
        <div class="control-group info">
          <div class="controls">
            <button type="submit" class="btn btn-danger" name="searchredbookbttn"><i class="icon-search icon-white"></i>&nbsp;Хайх</button>
          </div>
        </div>
      </div>
    </form>
