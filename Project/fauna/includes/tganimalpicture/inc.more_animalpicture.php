...
<div class="more-table">
  <table class="table table-bordered table-striped table-hover">
    ...
    <tbody>
      ...
      <tr>
        <td colspan="2"><div class="span2"> <a href="#" data-toggle="lightbox" data-target="#lightbox1" > <img  class="thumbnail" src="<?php echo $row[$i]["photo_pathname"].$row[$i]["photo_filename"];?>"  title="Амьтны зураг"/></a>
            <!-- Modal -->
