  ...
  <div class="home-button">
    ...
    <?php		
			...
			{           
				...
				{
			?>
    <a href="<?php echo $my_url.$my_page."&action=more&family_id=".$rows[$i]["family_id"]; ?>" title="Дэлгэрэнгүй харах"><?php echo $rows[$i]["family_name_mn"]; ?></a><br>
    <?php
				}
			}
		?>
