...
<div class="more-table">
  <table class="table table-bordered table-striped table-hover">
    <thead>
      <tr>
        <th colspan="2"><?php echo getdata($ITEM_TYPE, 6); ?> дэлгэрэнгүй харах</th>
      </tr>
    </thead>
    <tbody>
      <tr>
      ...
      <tr>
        ...
        <td><?php 
			...
			?></td>
        <?php if(!empty($row[$i]["class_citation_author"]) && !empty($row[$i]["class_citation_year"])) { ?>
      <tr>
      ...
      <?php } ?>
      <?php if(!empty($row[$i]["class_alternative_name"])) { ?>
      <tr>
      ...
      <?php if(!empty($row[$i]["order_citation_author"]) && !empty($row[$i]["order_citation_year"])) { ?>
      <tr>
      ...
      <?php } ?>
      <?php if(!empty($row[$i]["order_alternative_name"])) { ?>
      <tr>
      ...
      <?php if(!empty($row[$i]["family_citation_author"]) && !empty($row[$i]["family_citation_year"])) { ?>
      <tr>
      ...
      <?php } ?>
      <?php if(!empty($row[$i]["family_alternative_name"])) { ?>
      <tr>
