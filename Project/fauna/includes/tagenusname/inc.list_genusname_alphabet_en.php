  ...
  <div class="home-button">
    ...
    <?php		
			...
			{           
				...
				{
		?>
    <a href="<?php echo $my_url.$my_page."&action=more&genus_id=".$rows[$i]["genus_id"]."&genus_code=".$rows[$i]["genus_code"]; ?>" title="Дэлгэрэнгүй харах"><?php echo $rows[$i]["genus_name"]; ?></a><br>
    <?php
				}
			}
		?>
