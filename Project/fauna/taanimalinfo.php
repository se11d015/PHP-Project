<?php
   ...
   if(empty($species_name_mn))
	...
	if ($action == "outputanimalpicture") {
		require("tganimalpicture/inc.output_animalpictureform.php");
	} elseif ($action == "outputanimalherbarium") {
		require("tganimalherbarium/inc.output_animalherbariumform.php");
	} elseif ($action == "more") {
        require("includes/taanimalinfo/inc.more_animalinfo.php");
    } else {
        require("includes/taanimalinfo/inc.list_animalinfo.php");
    }
?>
