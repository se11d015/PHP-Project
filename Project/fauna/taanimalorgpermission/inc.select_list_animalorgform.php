...
require("taanimalorgpermission/inc.search_select_animalorgform.php");
    ...
    <tbody>
      ...
      <tr>
        ...
        <td align="center"><?php 
			...
			{ 
			?>
          <a href="<?php echo $my_url_old.$my_page.$search_url_new.$sort_url_new."&action=add&org_id=".$rows[$i]["org_id"]; ?>" title="<?php echo getdata($ITEM_TYPE, 41); ?> нэмэх"><i class="icon-plus"></i></a>
          <?php 
