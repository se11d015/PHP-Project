...
$startQuery = "SELECT";
$valueQuery = " COUNT(*) AS num_count   FROM ".$schemas.".taanimalusepermission tgcpe, ".$schemas.".tganimaluseentity tgcen, ".$schemas.".taanimalusename tgcna,".$schemas.".takingdomname takn,".$schemas.".taphylumname tadn,".$schemas.".taclassname tacn,".$schemas.".taordername taon,".$schemas.".tafamilyname tafn,".$schemas.".tagenusname tagn,".$schemas.".taanimalname taan";
...
require("inc.search_animalusenameform.php");
...
<div class="list-table">
  <table class="table table-bordered table-hover">
    <thead>
      <tr>
        <th colspan="8"><span class="title"><?php echo getdata($ITEM_TYPE, 72); ?></span></th>
      </tr>
    </thead>
    <thead>
      <tr>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><?php echo $rows[$i]["use_amount"]; ?></td>
