...
function addsubmitform()
{
    if (document.getElementById("species_code").value==""){
        ...
        document.getElementById("insertanimalinfobttn").value = "1";
...
<div class="add-table">
  <table class="table table-bordered table-condensed">
    <thead>
      <tr>
        <th><?php echo getdata($ITEM_TYPE, 10); ?> бүртгэх хэсэг</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td><form class="form-horizontal" action="<?php echo $my_url . $search_url . $sort_url; ?>" enctype="multipart/form-data" method="post" name="mainform" id="mainform">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <textarea name="distribution_mn" id="distribution_mn" rows="3" class="span5"></textarea>
                <span class="help-inline">Тэмдэгтийн тоо хязгааргүй.</span> </div>
            </div>
            <div class="control-group">
              <label class="control-label">Тархац, англиар:</label>
              <div class="controls">
                <textarea name="distribution_en" id="distribution_en" rows="3" class="span5"></textarea>
                <span class="help-inline">Тэмдэгтийн тоо хязгааргүй.</span> </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <textarea name="benefit_mn" id="benefit_mn" rows="3" class="span5"></textarea>
                <span class="help-inline">Тэмдэгтийн тоо хязгааргүй.</span> </div>
            </div>
            <div class="control-group">
              <label class="control-label">Ач холбогдол, англиар:</label>
              <div class="controls">
                <textarea name="benefit_en" id="benefit_en" rows="3" class="span5"></textarea>
                <span class="help-inline">Тэмдэгтийн тоо хязгааргүй.</span> </div>
            </div>
            <div class="control-group">
            ...
            <input type="hidden" id="insertanimalinfobttn" name="insertanimalinfobttn" value="0"/>
