...
<div class="more-table">
  <table class="table table-bordered table-striped table-hover">
    <thead>
      <tr>
        <th colspan="2"><?php echo getdata($ITEM_TYPE, 110); ?>  (дэлгэрэнгүй) </th>
      </tr>
    </thead>
    <tbody>
      <tr>
...
<div>
  <?php
                    if ($sess_profile == 1) {
                        ?>
  <a class="btn btn-danger" href="<?php echo $my_url . $my_page . $search_url . $sort_url . "&action=edit&contagion_id=" . $row[$i]["contagion_id"]; ?>"><i class="icon-edit icon-white"></i>&nbsp;Засварлах</a>&nbsp;
  <?php
