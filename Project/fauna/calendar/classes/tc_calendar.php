...
class tc_calendar
{
	...
	function getDayHeaders(){
		$rtn_hdrs = array();
		$hdrs = array("0"=>"Ня", "1"=>"Да", "2"=>"Мя", "3"=>"Лх", "4"=>"Пү", "5"=>"Ба", "6"=>"Бя");
	...
	function writeDay(){
		...
		echo("<select class='span2' name=\"".$this->objname."_day\" id=\"".$this->objname."_day\" onChange=\"javascript:tc_setDay('".$this->objname."', this[this.selectedIndex].value);\" class=\"tcday\"".($this->rtl ? " dir=\"rtl\"": "").">");
		echo("<option value=\"00\"".($this->rtl ? " dir=\"rtl\"": "").">Өдөр</option>");
	...
	function writeMonth(){
		echo("<select class='span2' name=\"".$this->objname."_month\" id=\"".$this->objname."_month\" onChange=\"javascript:tc_setMonth('".$this->objname."', this[this.selectedIndex].value);\" class=\"tcmonth\"".($this->rtl ? " dir=\"rtl\"": "").">");
		echo("<option value=\"00\"".($this->rtl ? " dir=\"rtl\"": "").">Сар</option>");
	...
	function writeYear(){
		...
		echo("<select class='span2' name=\"".$this->objname."_year\" id=\"".$this->objname."_year\" onChange=\"javascript:tc_setYear('".$this->objname."', this[this.selectedIndex].value);\" class=\"tcyear\"".($this->rtl ? " dir=\"rtl\"": "").">");
		echo("<option value=\"0000\"".($this->rtl ? " dir=\"rtl\"": "").">Жил</option>");
	...
	function getMonthNames(){
		return array("1-р сар", "2-р сар", "3-р сар", "4-р сар", "5-р сар", "6-р сар", "7-р сар", "8-р сар", "9-р сар", "10-р сар", "11-р сар", "12-р сар");
	}
