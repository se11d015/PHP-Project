...
<div class="more-table">
  <table class="table table-bordered table-striped table-hover">
    ...
    <tbody>
		...
		<?php
	for ($k = 0; $k < sizeof($row2); $k++) {
?>		
	<tr>
	   <td><?php echo $row2[$k]["type_name"]; ?></td>
	   <td><?php echo $row2[$k]["doc_date"]; ?></td>
	   <td><?php if(strlen($row2[$k]["doc_filename"])>0) { ?>
        <a href="<?php echo $row2[$k]["doc_pathname"]."/".$row2[$k]["doc_filename"]; ?>" target="_blank">Файл харах</a>&nbsp;
	</tr>
	<?php }} ?>
    </tbody>
  </table>
