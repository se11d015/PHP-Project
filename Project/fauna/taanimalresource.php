<?php
	...
	$evaluated_date = (isset($_GET["evaluated_date"])) ? (int) $_GET["evaluated_date"] : 0;
   ...
   if(empty($species_name_mn))
	...
	if ($action == "more") {
		require("includes/taanimalresource/inc.more_animalresource.php");
	}else {
		require("includes/taanimalresource/inc.list_animalresource.php");
	}
?>
