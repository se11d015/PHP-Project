...
<div>
  <?php
	...
	{
	?>
  <a class="btn btn-danger" href="<?php echo $my_url.$my_page.$search_url.$sort_url."&action=edit&payment_id=".$row[$i]["payment_id"]; ?>"><i class="icon-edit icon-white"></i>&nbsp;Засварлах</a>
  <?php 
