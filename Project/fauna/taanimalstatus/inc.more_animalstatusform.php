...
$i = 0;
$startQuery = "SELECT";
$valueQuery = "taps.*,tcrn.reference_name ,  takn.kingdom_name, takn.kingdom_name_mn, takn.kingdom_name_en, takn.kingdom_name_ru, tapn.phylum_name, tapn.phylum_name_mn, tapn.phylum_name_en, tapn.phylum_name_ru, tacn.class_name, tacn.class_name_mn, tacn.class_name_en, tacn.class_name_ru, taon.order_name, taon.order_name_mn, taon.order_name_en, taon.order_name_ru, tafn.family_name, tafn.family_name_mn, tafn.family_name_en, tafn.family_name_ru, tagn.genus_name, tagn.genus_name_mn, tagn.genus_name_en, tagn.genus_name_ru, tapl.species_name, tapl.species_name_mn,  tapl.species_name_en, tapl.species_name_ru FROM ".$schemas.".taanimalname tapl, ".$schemas.".tagenusname tagn, ".$schemas.".tafamilyname tafn, ".$schemas.".taordername taon, ".$schemas.".taclassname tacn, ".$schemas.".taphylumname tapn, ".$schemas.".takingdomname takn, ".$schemas.".taanimalstatus taps, ".$schemas.".tcreferencestatus tcrn ";
$whereQuery = "WHERE  tapl.species_code = taps.species_code AND tapl.genus_code = tagn.genus_code AND tagn.family_code = tafn.family_code AND tafn.order_code = taon.order_code AND taon.class_code = tacn.class_code AND tacn.phylum_code = tapn.phylum_code AND tapn.kingdom_code=takn.kingdom_code AND taps.reference_code=tcrn.reference_code AND  taps.status_id  = ".$status_id;
...
<div class="more-table">
  <table class="table table-bordered table-striped table-hover">
    ...
    <tbody>
      ...
      <tr>
        <td class="span4"><strong>Төлөв байдлын нэр:</strong></td>
        <td><?php echo $row[$i]["reference_name"]; ?></td>
      </tr>
    </tbody>
  </table>
</div>
<div>
  <?php
	...
	{
	?>
  <a class="btn btn-danger" href="<?php echo $my_url.$my_page.$search_url.$sort_url."&action=edit&status_id=".$row[$i]["status_id"]; ?>"><i class="icon-edit icon-white"></i>&nbsp;Засварлах</a>&nbsp;
  <?php 
