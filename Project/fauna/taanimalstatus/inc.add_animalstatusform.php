...
function addsubmitform()
{
	...
	}else if (document.getElementById("reference_code").value == "") {
		alert("Төлөв байдлын нэрийг оруулна уу");
	}
	else {
		document.getElementById("insertanimalstatusbttn").value = "1";
...
<div class="add-table">
  <table class="table table-bordered table-condensed">
    <thead>
      <tr>
        <th><?php echo getdata($ITEM_TYPE, 12); ?> бүртгэх хэсэг</th>
      </tr>
    </thead>
    <tbody>
      <tr>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <?php
					...
					$rows = $db->query($selQuery);
					if(!empty($rows))
						echo seldatadb("reference_code", "span4", $rows, "reference_code", "reference_name", $rows[0]["reference_code"]);
					else
						echo seldatadb("reference_code", "span4", $rows, "reference_code", "reference_name",null);
					?>
                <span class="help-inline">Жагсаалтаас аль нэгийг нь сонгоно.</span> </div>
            </div>
            <input type="hidden" id="insertanimalstatusbttn" name="insertanimalstatusbttn" value="0"/>
